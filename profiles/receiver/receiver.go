...
type GetServiceCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl GetServiceCapabilities"`
}
...
type GetReceiversResponse struct {
	...
	Receivers []Receiver `xml:"Receivers,omitempty"`
}

// GetReceiver type
type GetReceiver struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl GetReceiver"`

	// The token of the receiver to be retrieved.
	ReceiverToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl ReceiverToken,omitempty"`
}

// GetReceiverResponse type
...
type CreateReceiver struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl CreateReceiver"`

	// The initial configuration for the new receiver.
	Configuration ReceiverConfiguration `xml:"http://www.onvif.org/ver10/receiver/wsdl Configuration,omitempty"`
}

// CreateReceiverResponse type
...
type DeleteReceiver struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl DeleteReceiver"`

	// The token of the receiver to be deleted.
	ReceiverToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl ReceiverToken,omitempty"`
}

// DeleteReceiverResponse type
type DeleteReceiverResponse struct {
	XMLName xml.Name `xml:"DeleteReceiverResponse"`
}

// ConfigureReceiver type
type ConfigureReceiver struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl ConfigureReceiver"`
...
// ConfigureReceiverResponse type
type ConfigureReceiverResponse struct {
	XMLName xml.Name `xml:"ConfigureReceiverResponse"`
}

// SetReceiverMode type
type SetReceiverMode struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl SetReceiverMode"`

	// The token of the receiver to be changed.
	ReceiverToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl ReceiverToken,omitempty"`

	// The new receiver mode. Options available are:
	Mode ReceiverMode `xml:"http://www.onvif.org/ver10/receiver/wsdl Mode,omitempty"`
}

// SetReceiverModeResponse type
type SetReceiverModeResponse struct {
	XMLName xml.Name `xml:"SetReceiverModeResponse"`
}

// GetReceiverState type
type GetReceiverState struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl GetReceiverState"`

	// The token of the receiver to be queried.
	ReceiverToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl ReceiverToken,omitempty"`
}

// GetReceiverStateResponse type
type GetReceiverStateResponse struct {
	...
	ReceiverState ReceiverStateInformation `xml:"ReceiverState,omitempty"`
}
...
type Capabilities struct {
	...
	RTP_Multicast bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RTP_Multicast,attr,omitempty"`

	// Indicates that the device can receive RTP/TCP streams

	RTP_TCP bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RTP_TCP,attr,omitempty"`

	// Indicates that the device can receive RTP/RTSP/TCP streams.

	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RTP_RTSP_TCP,attr,omitempty"`

	// The maximum number of receivers supported by the device.

	SupportedReceivers int32 `xml:"http://www.onvif.org/ver10/schema SupportedReceivers,attr,omitempty"`
...
type VideoSourceConfigurationOptions struct {
	...
	VideoSourceTokensAvailable []ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl VideoSourceTokensAvailable,omitempty"`
...
type RotateOptions struct {
	...
	Reboot bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Reboot,attr,omitempty"`
}
...
type VideoEncoderConfiguration struct {
	*ConfigurationEntity
	...
	GuaranteedFrameRate bool `xml:"http://www.onvif.org/ver10/receiver/wsdl GuaranteedFrameRate,attr,omitempty"`
}
...
type MetadataConfiguration struct {
	*ConfigurationEntity
	...
	Analytics bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Analytics,omitempty"`
	...
	GeoLocation bool `xml:"http://www.onvif.org/ver10/receiver/wsdl GeoLocation,attr,omitempty"`
}
...
type PTZFilter struct {
	...
	Status bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Status,omitempty"`

	// True if the metadata stream shall contain the PTZ position
	Position bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Position,omitempty"`
}
...
type PTZStatusFilterOptions struct {
	...
	PanTiltStatusSupported bool `xml:"http://www.onvif.org/ver10/receiver/wsdl PanTiltStatusSupported,omitempty"`

	// True if the device is able to stream zoom status inforamtion.
	ZoomStatusSupported bool `xml:"http://www.onvif.org/ver10/receiver/wsdl ZoomStatusSupported,omitempty"`

	// True if the device is able to stream the pan or tilt position.
	PanTiltPositionSupported bool `xml:"http://www.onvif.org/ver10/receiver/wsdl PanTiltPositionSupported,omitempty"`

	// True if the device is able to stream zoom position information.
	ZoomPositionSupported bool `xml:"http://www.onvif.org/ver10/receiver/wsdl ZoomPositionSupported,omitempty"`
...
type AudioOutputConfiguration struct {
	*ConfigurationEntity
	...
	OutputToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl OutputToken,omitempty"`
...
type MulticastConfiguration struct {
	...
	AutoStart bool `xml:"http://www.onvif.org/ver10/receiver/wsdl AutoStart,omitempty"`
}
...
type NetworkInterface struct {
	*DeviceEntity
	...
	Enabled bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Enabled,omitempty"`
...
type NetworkInterfaceConnectionSetting struct {
	...
	AutoNegotiation bool `xml:"http://www.onvif.org/ver10/receiver/wsdl AutoNegotiation,omitempty"`
...
type IPv6Configuration struct {
	...
	AcceptRouterAdvert bool `xml:"http://www.onvif.org/ver10/receiver/wsdl AcceptRouterAdvert,omitempty"`
...
type HostnameInformation struct {
	...
	FromDHCP bool `xml:"http://www.onvif.org/ver10/receiver/wsdl FromDHCP,omitempty"`
...
type NetworkZeroConfiguration struct {
	...
	InterfaceToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl InterfaceToken,omitempty"`
...
type Dot11SecurityConfiguration struct {
	...
	Dot1X ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl Dot1X,omitempty"`
...
type AnalyticsCapabilities struct {
	...
	RuleSupport bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RuleSupport,omitempty"`

	// Indicates whether or not modules are supported.
	AnalyticsModuleSupport bool `xml:"http://www.onvif.org/ver10/receiver/wsdl AnalyticsModuleSupport,omitempty"`
}
...
type EventCapabilities struct {
	...
	WSSubscriptionPolicySupport bool `xml:"http://www.onvif.org/ver10/receiver/wsdl WSSubscriptionPolicySupport,omitempty"`

	// Indicates whether or not WS Pull Point is supported.
	WSPullPointSupport bool `xml:"http://www.onvif.org/ver10/receiver/wsdl WSPullPointSupport,omitempty"`

	// Indicates whether or not WS Pausable Subscription Manager Interface is supported.
	WSPausableSubscriptionManagerInterfaceSupport bool `xml:"http://www.onvif.org/ver10/receiver/wsdl WSPausableSubscriptionManagerInterfaceSupport,omitempty"`
}
...
type IOCapabilitiesExtension struct {
	Auxiliary bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Auxiliary,omitempty"`
...
type RealTimeStreamingCapabilities struct {
	...
	RTPMulticast bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RTPMulticast,omitempty"`

	// Indicates whether or not RTP over TCP is supported.
	RTP_TCP bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RTP_TCP,omitempty"`

	// Indicates whether or not RTP/RTSP/TCP is supported.
	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RTP_RTSP_TCP,omitempty"`
...
type NetworkCapabilities struct {
	...
	IPFilter bool `xml:"http://www.onvif.org/ver10/receiver/wsdl IPFilter,omitempty"`

	// Indicates whether or not zeroconf is supported.
	ZeroConfiguration bool `xml:"http://www.onvif.org/ver10/receiver/wsdl ZeroConfiguration,omitempty"`

	// Indicates whether or not IPv6 is supported.
	IPVersion6 bool `xml:"http://www.onvif.org/ver10/receiver/wsdl IPVersion6,omitempty"`

	// Indicates whether or not  is supported.
	DynDNS bool `xml:"http://www.onvif.org/ver10/receiver/wsdl DynDNS,omitempty"`
...
type NetworkCapabilitiesExtension struct {
	Dot11Configuration bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Dot11Configuration,omitempty"`
...
type SecurityCapabilities struct {
	...
	OnboardKeyGeneration bool `xml:"http://www.onvif.org/ver10/receiver/wsdl OnboardKeyGeneration,omitempty"`

	// Indicates whether or not access policy configuration is supported.
	AccessPolicyConfig bool `xml:"http://www.onvif.org/ver10/receiver/wsdl AccessPolicyConfig,omitempty"`
	...
	SAMLToken bool `xml:"http://www.onvif.org/ver10/receiver/wsdl SAMLToken,omitempty"`

	// Indicates whether or not WS-Security Kerberos token is supported.
	KerberosToken bool `xml:"http://www.onvif.org/ver10/receiver/wsdl KerberosToken,omitempty"`

	// Indicates whether or not WS-Security REL token is supported.
	RELToken bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RELToken,omitempty"`
...
type SecurityCapabilitiesExtension2 struct {
	Dot1X bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Dot1X,omitempty"`
	...
	RemoteUserHandling bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RemoteUserHandling,omitempty"`
}
...
type SystemCapabilities struct {
	...
	DiscoveryResolve bool `xml:"http://www.onvif.org/ver10/receiver/wsdl DiscoveryResolve,omitempty"`

	// Indicates whether or not WS-Discovery Bye is supported.
	DiscoveryBye bool `xml:"http://www.onvif.org/ver10/receiver/wsdl DiscoveryBye,omitempty"`

	// Indicates whether or not remote discovery is supported.
	RemoteDiscovery bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RemoteDiscovery,omitempty"`

	// Indicates whether or not system backup is supported.
	SystemBackup bool `xml:"http://www.onvif.org/ver10/receiver/wsdl SystemBackup,omitempty"`

	// Indicates whether or not system logging is supported.
	SystemLogging bool `xml:"http://www.onvif.org/ver10/receiver/wsdl SystemLogging,omitempty"`

	// Indicates whether or not firmware upgrade is supported.
	FirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/receiver/wsdl FirmwareUpgrade,omitempty"`
...
type SystemCapabilitiesExtension struct {
	HttpFirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/receiver/wsdl HttpFirmwareUpgrade,omitempty"`

	HttpSystemBackup bool `xml:"http://www.onvif.org/ver10/receiver/wsdl HttpSystemBackup,omitempty"`

	HttpSystemLogging bool `xml:"http://www.onvif.org/ver10/receiver/wsdl HttpSystemLogging,omitempty"`

	HttpSupportInformation bool `xml:"http://www.onvif.org/ver10/receiver/wsdl HttpSupportInformation,omitempty"`
...
type DisplayCapabilities struct {
	...
	FixedLayout bool `xml:"http://www.onvif.org/ver10/receiver/wsdl FixedLayout,omitempty"`
}
...
type RecordingCapabilities struct {
	...
	ReceiverSource bool `xml:"http://www.onvif.org/ver10/receiver/wsdl ReceiverSource,omitempty"`

	MediaProfileSource bool `xml:"http://www.onvif.org/ver10/receiver/wsdl MediaProfileSource,omitempty"`

	DynamicRecordings bool `xml:"http://www.onvif.org/ver10/receiver/wsdl DynamicRecordings,omitempty"`

	DynamicTracks bool `xml:"http://www.onvif.org/ver10/receiver/wsdl DynamicTracks,omitempty"`
...
type SearchCapabilities struct {
	...
	MetadataSearch bool `xml:"http://www.onvif.org/ver10/receiver/wsdl MetadataSearch,omitempty"`
}
...
type ReceiverCapabilities struct {
	...
	RTP_Multicast bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RTP_Multicast,omitempty"`
...
type SystemDateTime struct {
	...
	DaylightSavings bool `xml:"http://www.onvif.org/ver10/receiver/wsdl DaylightSavings,omitempty"`
...
type CertificateUsage struct {
	...
	Critical bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Critical,attr,omitempty"`
}
...
type Dot1XConfiguration struct {
	Dot1XConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl Dot1XConfigurationToken,omitempty"`
...
type PTZNode struct {
	*DeviceEntity
	...
	//
	HomeSupported bool `xml:"http://www.onvif.org/ver10/receiver/wsdl HomeSupported,omitempty"`
	...
	FixedHomePosition bool `xml:"http://www.onvif.org/ver10/receiver/wsdl FixedHomePosition,attr,omitempty"`

	//
	// Indication whether the Node supports the geo-referenced move command.
	//

	GeoMove bool `xml:"http://www.onvif.org/ver10/receiver/wsdl GeoMove,attr,omitempty"`
}
...
type PTZConfiguration struct {
	*ConfigurationEntity
	...
	//
	NodeToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl NodeToken,omitempty"`
...
type PTZPresetTourPresetDetail struct {
	...
	PresetToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl PresetToken,omitempty"`
	...
	Home bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Home,omitempty"`
...
type PTZPresetTourStartingCondition struct {
	...
	RandomPresetOrder bool `xml:"http://www.onvif.org/ver10/receiver/wsdl RandomPresetOrder,attr,omitempty"`
}
...
type IrCutFilterAutoAdjustmentOptions struct {
	...
	BoundaryOffset bool `xml:"http://www.onvif.org/ver10/receiver/wsdl BoundaryOffset,omitempty"`
...
type ToneCompensationOptions struct {
	...
	Level bool `xml:"http://www.onvif.org/ver10/receiver/wsdl Level,omitempty"`
}
...
type MessageDescription struct {
	...
	IsProperty bool `xml:"http://www.onvif.org/ver10/receiver/wsdl IsProperty,attr,omitempty"`
}
...
type PaneLayout struct {
	...
	Pane ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl Pane,omitempty"`
...
type Receiver struct {
	...
	Token ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl Token,omitempty"`
...
// ReceiverStateInformation type
type ReceiverStateInformation struct {

	// The connection state of the receiver may have one of the following states:
	State ReceiverState `xml:"http://www.onvif.org/ver10/receiver/wsdl State,omitempty"`

	// Indicates whether or not the receiver was created automatically.
	AutoCreated bool `xml:"http://www.onvif.org/ver10/receiver/wsdl AutoCreated,omitempty"`
}
...
type MetadataAttributes struct {
	...
	CanContainPTZ bool `xml:"http://www.onvif.org/ver10/receiver/wsdl CanContainPTZ,omitempty"`

	// Indicates that there can be analytics data in the metadata track in the specified time interval.
	CanContainAnalytics bool `xml:"http://www.onvif.org/ver10/receiver/wsdl CanContainAnalytics,omitempty"`

	// Indicates that there can be notifications in the metadata track in the specified time interval.
	CanContainNotifications bool `xml:"http://www.onvif.org/ver10/receiver/wsdl CanContainNotifications,omitempty"`
...
type RecordingJobSource struct {
	...
	AutoCreateReceiver bool `xml:"http://www.onvif.org/ver10/receiver/wsdl AutoCreateReceiver,omitempty"`
...
type OSDTextConfiguration struct {
	...
	IsPersistentText bool `xml:"http://www.onvif.org/ver10/receiver/wsdl IsPersistentText,attr,omitempty"`
}
...
type StorageReferencePath struct {
	...
	StorageToken ReferenceToken `xml:"http://www.onvif.org/ver10/receiver/wsdl StorageToken,omitempty"`
...
type ReceiverPort interface {
	...
	*/
	GetReceivers(request *GetReceivers) (*GetReceiversResponse, error)

	GetReceiversContext(ctx context.Context, request *GetReceivers) (*GetReceiversResponse, error)

	/*
		Retrieves the details of a specific receiver. This operation is mandatory.
	*/
	GetReceiver(request *GetReceiver) (*GetReceiverResponse, error)

	GetReceiverContext(ctx context.Context, request *GetReceiver) (*GetReceiverResponse, error)
	...
	*/
	CreateReceiver(request *CreateReceiver) (*CreateReceiverResponse, error)

	CreateReceiverContext(ctx context.Context, request *CreateReceiver) (*CreateReceiverResponse, error)
	...
	*/
	DeleteReceiver(request *DeleteReceiver) (*DeleteReceiverResponse, error)

	DeleteReceiverContext(ctx context.Context, request *DeleteReceiver) (*DeleteReceiverResponse, error)

	/*
		Configures an existing receiver. This operation is mandatory.
	*/
	ConfigureReceiver(request *ConfigureReceiver) (*ConfigureReceiverResponse, error)

	ConfigureReceiverContext(ctx context.Context, request *ConfigureReceiver) (*ConfigureReceiverResponse, error)

	/*
		Sets the mode of the receiver without affecting the rest of its configuration.
		This operation is mandatory.
	*/
	SetReceiverMode(request *SetReceiverMode) (*SetReceiverModeResponse, error)

	SetReceiverModeContext(ctx context.Context, request *SetReceiverMode) (*SetReceiverModeResponse, error)
	...
	/*
		...
		This operation is mandatory.
	*/
	GetReceiverState(request *GetReceiverState) (*GetReceiverStateResponse, error)

	GetReceiverStateContext(ctx context.Context, request *GetReceiverState) (*GetReceiverStateResponse, error)
}
...
func NewReceiverPort(client *soap.Client, xaddr string) ReceiverPort {
	return &receiverPort{
		client: client,
		xaddr:  xaddr,
	}
...
func (service *receiverPort) GetServiceCapabilities(request *GetServiceCapabilities) (*GetServiceCapabilitiesResponse, error) {
...
func (service *receiverPort) GetReceivers(request *GetReceivers) (*GetReceiversResponse, error) {
	return service.GetReceiversContext(
		context.Background(),
		request,
	)
}
...
func (service *receiverPort) GetReceiver(request *GetReceiver) (*GetReceiverResponse, error) {
	return service.GetReceiverContext(
		context.Background(),
		request,
	)
}
...
func (service *receiverPort) CreateReceiver(request *CreateReceiver) (*CreateReceiverResponse, error) {
	return service.CreateReceiverContext(
		context.Background(),
		request,
	)
}
...
func (service *receiverPort) DeleteReceiver(request *DeleteReceiver) (*DeleteReceiverResponse, error) {
	return service.DeleteReceiverContext(
		context.Background(),
		request,
	)
}
...
func (service *receiverPort) ConfigureReceiver(request *ConfigureReceiver) (*ConfigureReceiverResponse, error) {
	return service.ConfigureReceiverContext(
		context.Background(),
		request,
	)
}
...
func (service *receiverPort) SetReceiverMode(request *SetReceiverMode) (*SetReceiverModeResponse, error) {
	return service.SetReceiverModeContext(
		context.Background(),
		request,
	)
}
...
func (service *receiverPort) GetReceiverState(request *GetReceiverState) (*GetReceiverStateResponse, error) {
	return service.GetReceiverStateContext(
		context.Background(),
		request,
	)
}
