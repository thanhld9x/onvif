...
type GetNode struct {
	...
	//
	NodeToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl NodeToken,omitempty"`
}
...
type GetConfiguration struct {
	...
	//
	PTZConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl PTZConfigurationToken,omitempty"`
}
...
type SetConfiguration struct {
	...
	PTZConfiguration PTZConfiguration `xml:"http://www.onvif.org/ver20/ptz/wsdl PTZConfiguration,omitempty"`

	// Flag that makes configuration persistent. Example: User wants the configuration to exist after reboot.
	//
	ForcePersistence bool `xml:"http://www.onvif.org/ver20/ptz/wsdl ForcePersistence,omitempty"`
}
...
type GetConfigurationOptions struct {
	...
	//
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl ConfigurationToken,omitempty"`
}
...
type GetConfigurationOptionsResponse struct {
	...
	//
	PTZConfigurationOptions PTZConfigurationOptions `xml:"PTZConfigurationOptions,omitempty"`
}
...
type SendAuxiliaryCommand struct {
	...
	//
	ProfileToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl ProfileToken,omitempty"`

	// The Auxiliary request data.
	//
	AuxiliaryData AuxiliaryData `xml:"http://www.onvif.org/ver20/ptz/wsdl AuxiliaryData,omitempty"`
}
...
type SendAuxiliaryCommandResponse struct {
	...
	//
	AuxiliaryResponse AuxiliaryData `xml:"AuxiliaryResponse,omitempty"`
}
...
type GetPresetsResponse struct {
	...
	//
	Preset []PTZPreset `xml:"Preset,omitempty"`
}
...
type SetPreset struct {
	...
	//
	PresetName string `xml:"http://www.onvif.org/ver20/ptz/wsdl PresetName,omitempty"`

	// A requested preset token.
	//
	PresetToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl PresetToken,omitempty"`
}

// SetPresetResponse type
...
type ContinuousMove struct {
	...
	//
	Velocity PTZSpeed `xml:"http://www.onvif.org/ver20/ptz/wsdl Velocity,omitempty"`
...
type AbsoluteMove struct {
	...
	//
	Position PTZVector `xml:"http://www.onvif.org/ver20/ptz/wsdl Position,omitempty"`
...
type GeoMove struct {
	...
	//
	Target GeoLocation `xml:"http://www.onvif.org/ver20/ptz/wsdl Target,omitempty"`
	...
	//
	AreaHeight float32 `xml:"http://www.onvif.org/ver10/schema AreaHeight,omitempty"`

	// An optional indication of the width of the target/area.
	//
	AreaWidth float32 `xml:"http://www.onvif.org/ver10/schema AreaWidth,omitempty"`
}

// GeoMoveResponse type
type GeoMoveResponse struct {
	XMLName xml.Name `xml:"GeoMoveResponse"`
}
...
type Stop struct {
	...
	//
	PanTilt bool `xml:"http://www.onvif.org/ver20/ptz/wsdl PanTilt,omitempty"`
	...
	//
	Zoom bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Zoom,omitempty"`
}
...
type GetPresetTour struct {
	...
	PresetTourToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl PresetTourToken,omitempty"`
}

// GetPresetTourResponse type
...
// GetPresetTourOptionsResponse type
type GetPresetTourOptionsResponse struct {
	XMLName xml.Name `xml:"GetPresetTourOptionsResponse"`

	Options PTZPresetTourOptions `xml:"Options,omitempty"`
}

// CreatePresetTour type
...
// CreatePresetTourResponse type
type CreatePresetTourResponse struct {
	XMLName xml.Name `xml:"CreatePresetTourResponse"`

	PresetTourToken ReferenceToken `xml:"PresetTourToken,omitempty"`
}

// ModifyPresetTour type
type ModifyPresetTour struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/ptz/wsdl ModifyPresetTour"`

	ProfileToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl ProfileToken,omitempty"`

	PresetTour PresetTour `xml:"http://www.onvif.org/ver20/ptz/wsdl PresetTour,omitempty"`
}

// ModifyPresetTourResponse type
type ModifyPresetTourResponse struct {
	XMLName xml.Name `xml:"ModifyPresetTourResponse"`
}

// OperatePresetTour type
type OperatePresetTour struct {
	...
	Operation PTZPresetTourOperation `xml:"http://www.onvif.org/ver20/ptz/wsdl Operation,omitempty"`
}

// OperatePresetTourResponse type
type OperatePresetTourResponse struct {
	XMLName xml.Name `xml:"OperatePresetTourResponse"`
}

// RemovePresetTour type
...
// RemovePresetTourResponse type
type RemovePresetTourResponse struct {
	XMLName xml.Name `xml:"RemovePresetTourResponse"`
}

// GetCompatibleConfigurations type
...
// GetCompatibleConfigurationsResponse type
...
type Capabilities struct {
	...
	EFlip bool `xml:"http://www.onvif.org/ver20/ptz/wsdl EFlip,attr,omitempty"`

	// Indicates whether or not reversing of PT control direction is supported.

	Reverse bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Reverse,attr,omitempty"`

	// Indicates support for the GetCompatibleConfigurations command.

	GetCompatibleConfigurations bool `xml:"http://www.onvif.org/ver20/ptz/wsdl GetCompatibleConfigurations,attr,omitempty"`

	// Indicates that the PTZStatus includes MoveStatus information.

	MoveStatus bool `xml:"http://www.onvif.org/ver20/ptz/wsdl MoveStatus,attr,omitempty"`

	// Indicates that the PTZStatus includes Position information.

	StatusPosition bool `xml:"http://www.onvif.org/ver20/ptz/wsdl StatusPosition,attr,omitempty"`
}
...
type PTZStatus struct {
	...
	//
	Error string `xml:"http://www.onvif.org/ver20/ptz/wsdl Error,omitempty"`
...
type VideoSourceConfiguration struct {
	*ConfigurationEntity
	...
	SourceToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl SourceToken,omitempty"`
	...
	ViewMode string `xml:"http://www.onvif.org/ver20/ptz/wsdl ViewMode,attr,omitempty"`
}
...
type VideoSourceConfigurationOptions struct {
	...
	VideoSourceTokensAvailable []ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl VideoSourceTokensAvailable,omitempty"`
...
type RotateOptions struct {
	...
	Reboot bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Reboot,attr,omitempty"`
}
...
type SceneOrientation struct {
	...
	//
	Orientation string `xml:"http://www.onvif.org/ver20/ptz/wsdl Orientation,omitempty"`
}
...
type VideoEncoderConfiguration struct {
	*ConfigurationEntity
	...
	GuaranteedFrameRate bool `xml:"http://www.onvif.org/ver20/ptz/wsdl GuaranteedFrameRate,attr,omitempty"`
}
...
type MetadataConfiguration struct {
	*ConfigurationEntity
	...
	Analytics bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Analytics,omitempty"`
	...
	CompressionType string `xml:"http://www.onvif.org/ver20/ptz/wsdl CompressionType,attr,omitempty"`

	// Optional parameter to configure if the metadata stream shall contain the Geo Location coordinates of each target.

	GeoLocation bool `xml:"http://www.onvif.org/ver20/ptz/wsdl GeoLocation,attr,omitempty"`
}
...
type PTZFilter struct {
	...
	Status bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Status,omitempty"`

	// True if the metadata stream shall contain the PTZ position
	Position bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Position,omitempty"`
}
...
type MetadataConfigurationOptionsExtension struct {
	...
	CompressionType []string `xml:"http://www.onvif.org/ver20/ptz/wsdl CompressionType,omitempty"`
...
type PTZStatusFilterOptions struct {
	...
	PanTiltStatusSupported bool `xml:"http://www.onvif.org/ver20/ptz/wsdl PanTiltStatusSupported,omitempty"`

	// True if the device is able to stream zoom status inforamtion.
	ZoomStatusSupported bool `xml:"http://www.onvif.org/ver20/ptz/wsdl ZoomStatusSupported,omitempty"`

	// True if the device is able to stream the pan or tilt position.
	PanTiltPositionSupported bool `xml:"http://www.onvif.org/ver20/ptz/wsdl PanTiltPositionSupported,omitempty"`

	// True if the device is able to stream zoom position information.
	ZoomPositionSupported bool `xml:"http://www.onvif.org/ver20/ptz/wsdl ZoomPositionSupported,omitempty"`
...
type AudioOutputConfiguration struct {
	*ConfigurationEntity
	...
	OutputToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl OutputToken,omitempty"`
...
type MulticastConfiguration struct {
	...
	AutoStart bool `xml:"http://www.onvif.org/ver20/ptz/wsdl AutoStart,omitempty"`
}
...
type NetworkInterface struct {
	*DeviceEntity
	...
	Enabled bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Enabled,omitempty"`
...
type NetworkInterfaceConnectionSetting struct {
	...
	AutoNegotiation bool `xml:"http://www.onvif.org/ver20/ptz/wsdl AutoNegotiation,omitempty"`
...
type NetworkInterfaceInfo struct {
	...
	Name string `xml:"http://www.onvif.org/ver20/ptz/wsdl Name,omitempty"`
...
type IPv4Configuration struct {
	...
	DHCP bool `xml:"http://www.onvif.org/ver20/ptz/wsdl DHCP,omitempty"`
}
...
type IPv6Configuration struct {
	...
	AcceptRouterAdvert bool `xml:"http://www.onvif.org/ver20/ptz/wsdl AcceptRouterAdvert,omitempty"`
...
type HostnameInformation struct {
	...
	FromDHCP bool `xml:"http://www.onvif.org/ver20/ptz/wsdl FromDHCP,omitempty"`
...
type DNSInformation struct {
	...
	// Search domain.
	SearchDomain []string `xml:"http://www.onvif.org/ver20/ptz/wsdl SearchDomain,omitempty"`
...
type NetworkZeroConfiguration struct {
	...
	InterfaceToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl InterfaceToken,omitempty"`
...
type Dot11SecurityConfiguration struct {
	...
	Dot1X ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl Dot1X,omitempty"`
...
type Dot11AvailableNetworks struct {
	...
	BSSID string `xml:"http://www.onvif.org/ver20/ptz/wsdl BSSID,omitempty"`
...
type AnalyticsCapabilities struct {
	...
	RuleSupport bool `xml:"http://www.onvif.org/ver20/ptz/wsdl RuleSupport,omitempty"`

	// Indicates whether or not modules are supported.
	AnalyticsModuleSupport bool `xml:"http://www.onvif.org/ver20/ptz/wsdl AnalyticsModuleSupport,omitempty"`
}
...
type EventCapabilities struct {
	...
	WSSubscriptionPolicySupport bool `xml:"http://www.onvif.org/ver20/ptz/wsdl WSSubscriptionPolicySupport,omitempty"`

	// Indicates whether or not WS Pull Point is supported.
	WSPullPointSupport bool `xml:"http://www.onvif.org/ver20/ptz/wsdl WSPullPointSupport,omitempty"`

	// Indicates whether or not WS Pausable Subscription Manager Interface is supported.
	WSPausableSubscriptionManagerInterfaceSupport bool `xml:"http://www.onvif.org/ver20/ptz/wsdl WSPausableSubscriptionManagerInterfaceSupport,omitempty"`
}
...
type IOCapabilitiesExtension struct {
	Auxiliary bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Auxiliary,omitempty"`

	AuxiliaryCommands []AuxiliaryData `xml:"http://www.onvif.org/ver20/ptz/wsdl AuxiliaryCommands,omitempty"`
...
type RealTimeStreamingCapabilities struct {
	...
	RTPMulticast bool `xml:"http://www.onvif.org/ver20/ptz/wsdl RTPMulticast,omitempty"`

	// Indicates whether or not RTP over TCP is supported.
	RTP_TCP bool `xml:"http://www.onvif.org/ver20/ptz/wsdl RTP_TCP,omitempty"`

	// Indicates whether or not RTP/RTSP/TCP is supported.
	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver20/ptz/wsdl RTP_RTSP_TCP,omitempty"`
...
type NetworkCapabilities struct {
	...
	IPFilter bool `xml:"http://www.onvif.org/ver20/ptz/wsdl IPFilter,omitempty"`

	// Indicates whether or not zeroconf is supported.
	ZeroConfiguration bool `xml:"http://www.onvif.org/ver20/ptz/wsdl ZeroConfiguration,omitempty"`

	// Indicates whether or not IPv6 is supported.
	IPVersion6 bool `xml:"http://www.onvif.org/ver20/ptz/wsdl IPVersion6,omitempty"`

	// Indicates whether or not  is supported.
	DynDNS bool `xml:"http://www.onvif.org/ver20/ptz/wsdl DynDNS,omitempty"`
...
type NetworkCapabilitiesExtension struct {
	Dot11Configuration bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Dot11Configuration,omitempty"`
...
type SecurityCapabilities struct {
	...
	OnboardKeyGeneration bool `xml:"http://www.onvif.org/ver20/ptz/wsdl OnboardKeyGeneration,omitempty"`

	// Indicates whether or not access policy configuration is supported.
	AccessPolicyConfig bool `xml:"http://www.onvif.org/ver20/ptz/wsdl AccessPolicyConfig,omitempty"`
	...
	SAMLToken bool `xml:"http://www.onvif.org/ver20/ptz/wsdl SAMLToken,omitempty"`

	// Indicates whether or not WS-Security Kerberos token is supported.
	KerberosToken bool `xml:"http://www.onvif.org/ver20/ptz/wsdl KerberosToken,omitempty"`

	// Indicates whether or not WS-Security REL token is supported.
	RELToken bool `xml:"http://www.onvif.org/ver20/ptz/wsdl RELToken,omitempty"`
...
type SecurityCapabilitiesExtension2 struct {
	Dot1X bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Dot1X,omitempty"`
	...
	RemoteUserHandling bool `xml:"http://www.onvif.org/ver20/ptz/wsdl RemoteUserHandling,omitempty"`
}
...
type SystemCapabilities struct {
	...
	DiscoveryResolve bool `xml:"http://www.onvif.org/ver20/ptz/wsdl DiscoveryResolve,omitempty"`

	// Indicates whether or not WS-Discovery Bye is supported.
	DiscoveryBye bool `xml:"http://www.onvif.org/ver20/ptz/wsdl DiscoveryBye,omitempty"`

	// Indicates whether or not remote discovery is supported.
	RemoteDiscovery bool `xml:"http://www.onvif.org/ver20/ptz/wsdl RemoteDiscovery,omitempty"`

	// Indicates whether or not system backup is supported.
	SystemBackup bool `xml:"http://www.onvif.org/ver20/ptz/wsdl SystemBackup,omitempty"`

	// Indicates whether or not system logging is supported.
	SystemLogging bool `xml:"http://www.onvif.org/ver20/ptz/wsdl SystemLogging,omitempty"`

	// Indicates whether or not firmware upgrade is supported.
	FirmwareUpgrade bool `xml:"http://www.onvif.org/ver20/ptz/wsdl FirmwareUpgrade,omitempty"`
...
type SystemCapabilitiesExtension struct {
	HttpFirmwareUpgrade bool `xml:"http://www.onvif.org/ver20/ptz/wsdl HttpFirmwareUpgrade,omitempty"`

	HttpSystemBackup bool `xml:"http://www.onvif.org/ver20/ptz/wsdl HttpSystemBackup,omitempty"`

	HttpSystemLogging bool `xml:"http://www.onvif.org/ver20/ptz/wsdl HttpSystemLogging,omitempty"`

	HttpSupportInformation bool `xml:"http://www.onvif.org/ver20/ptz/wsdl HttpSupportInformation,omitempty"`
...
type DisplayCapabilities struct {
	...
	FixedLayout bool `xml:"http://www.onvif.org/ver20/ptz/wsdl FixedLayout,omitempty"`
}
...
type RecordingCapabilities struct {
	...
	ReceiverSource bool `xml:"http://www.onvif.org/ver20/ptz/wsdl ReceiverSource,omitempty"`

	MediaProfileSource bool `xml:"http://www.onvif.org/ver20/ptz/wsdl MediaProfileSource,omitempty"`

	DynamicRecordings bool `xml:"http://www.onvif.org/ver20/ptz/wsdl DynamicRecordings,omitempty"`

	DynamicTracks bool `xml:"http://www.onvif.org/ver20/ptz/wsdl DynamicTracks,omitempty"`
...
type SearchCapabilities struct {
	...
	MetadataSearch bool `xml:"http://www.onvif.org/ver20/ptz/wsdl MetadataSearch,omitempty"`
}
...
type ReceiverCapabilities struct {
	...
	RTP_Multicast bool `xml:"http://www.onvif.org/ver20/ptz/wsdl RTP_Multicast,omitempty"`
...
type SystemDateTime struct {
	...
	DaylightSavings bool `xml:"http://www.onvif.org/ver20/ptz/wsdl DaylightSavings,omitempty"`
...
type TimeZone struct {
	...
	TZ string `xml:"http://www.onvif.org/ver20/ptz/wsdl TZ,omitempty"`
}
...
type User struct {
	...
	// Username string.
	Username string `xml:"http://www.onvif.org/ver20/ptz/wsdl Username,omitempty"`

	// Password string.
	Password string `xml:"http://www.onvif.org/ver20/ptz/wsdl Password,omitempty"`
...
type CertificateGenerationParameters struct {
	CertificateID string `xml:"http://www.onvif.org/ver20/ptz/wsdl CertificateID,omitempty"`

	Subject string `xml:"http://www.onvif.org/ver20/ptz/wsdl Subject,omitempty"`

	ValidNotBefore string `xml:"http://www.onvif.org/ver20/ptz/wsdl ValidNotBefore,omitempty"`

	ValidNotAfter string `xml:"http://www.onvif.org/ver20/ptz/wsdl ValidNotAfter,omitempty"`
...
type CertificateInformation struct {
	...
	IssuerDN string `xml:"http://www.onvif.org/ver20/ptz/wsdl IssuerDN,omitempty"`

	SubjectDN string `xml:"http://www.onvif.org/ver20/ptz/wsdl SubjectDN,omitempty"`
	...
	Version string `xml:"http://www.onvif.org/ver20/ptz/wsdl Version,omitempty"`

	SerialNum string `xml:"http://www.onvif.org/ver20/ptz/wsdl SerialNum,omitempty"`

	// Validity Range is from "NotBefore" to "NotAfter"; the corresponding DateTimeRange is from "From" to "Until"
	SignatureAlgorithm string `xml:"http://www.onvif.org/ver20/ptz/wsdl SignatureAlgorithm,omitempty"`
...
type CertificateUsage struct {
	...
	Critical bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Critical,attr,omitempty"`
}
...
type Dot1XConfiguration struct {
	Dot1XConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl Dot1XConfigurationToken,omitempty"`

	Identity string `xml:"http://www.onvif.org/ver20/ptz/wsdl Identity,omitempty"`

	AnonymousID string `xml:"http://www.onvif.org/ver20/ptz/wsdl AnonymousID,omitempty"`
	...
	CACertificateID []string `xml:"http://www.onvif.org/ver20/ptz/wsdl CACertificateID,omitempty"`
...
type PTZNode struct {
	*DeviceEntity
	...
	//
	HomeSupported bool `xml:"http://www.onvif.org/ver20/ptz/wsdl HomeSupported,omitempty"`
	...
	FixedHomePosition bool `xml:"http://www.onvif.org/ver20/ptz/wsdl FixedHomePosition,attr,omitempty"`

	//
	// Indication whether the Node supports the geo-referenced move command.
	//

	GeoMove bool `xml:"http://www.onvif.org/ver20/ptz/wsdl GeoMove,attr,omitempty"`
}
...
type PTZPresetTourSupported struct {
	...
	PTZPresetTourOperation []PTZPresetTourOperation `xml:"http://www.onvif.org/ver20/ptz/wsdl PTZPresetTourOperation,omitempty"`
...
type PTZConfiguration struct {
	*ConfigurationEntity
	...
	//
	DefaultPTZSpeed PTZSpeed `xml:"http://www.onvif.org/ver20/ptz/wsdl DefaultPTZSpeed,omitempty"`
...
type PTZPreset struct {
	...
	//
	PTZPosition PTZVector `xml:"http://www.onvif.org/ver20/ptz/wsdl PTZPosition,omitempty"`
...
type PresetTour struct {
	...
	Status PTZPresetTourStatus `xml:"http://www.onvif.org/ver10/schema Status,omitempty"`
	...
	StartingCondition PTZPresetTourStartingCondition `xml:"http://www.onvif.org/ver10/schema StartingCondition,omitempty"`

	// A list of detail of touring spots including preset positions.
	TourSpot []PTZPresetTourSpot `xml:"http://www.onvif.org/ver10/schema TourSpot,omitempty"`

	Extension PTZPresetTourExtension `xml:"http://www.onvif.org/ver10/schema Extension,omitempty"`
...
type PTZPresetTourPresetDetail struct {
	...
	Home bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Home,omitempty"`
...
type PTZPresetTourStartingCondition struct {
	...
	RandomPresetOrder bool `xml:"http://www.onvif.org/ver20/ptz/wsdl RandomPresetOrder,attr,omitempty"`
}
...
type PTZPresetTourOptions struct {
	...
	StartingCondition PTZPresetTourStartingConditionOptions `xml:"http://www.onvif.org/ver10/schema StartingCondition,omitempty"`

	// Supported options for Preset Tour Spot.
	TourSpot PTZPresetTourSpotOptions `xml:"http://www.onvif.org/ver10/schema TourSpot,omitempty"`
}

// PTZPresetTourSpotOptions type
type PTZPresetTourSpotOptions struct {

	// Supported options for detail definition of preset position of the tour spot.
	PresetDetail PTZPresetTourPresetDetailOptions `xml:"http://www.onvif.org/ver10/schema PresetDetail,omitempty"`

	// Supported range of stay time for a tour spot.
	StayTime DurationRange `xml:"http://www.onvif.org/ver10/schema StayTime,omitempty"`
}
...
type IrCutFilterAutoAdjustment struct {
	...
	BoundaryType string `xml:"http://www.onvif.org/ver20/ptz/wsdl BoundaryType,omitempty"`
...
type ToneCompensation struct {
	...
	Mode string `xml:"http://www.onvif.org/ver20/ptz/wsdl Mode,omitempty"`
...
type IrCutFilterAutoAdjustmentOptions struct {
	...
	BoundaryOffset bool `xml:"http://www.onvif.org/ver20/ptz/wsdl BoundaryOffset,omitempty"`
...
type ToneCompensationOptions struct {
	...
	Level bool `xml:"http://www.onvif.org/ver20/ptz/wsdl Level,omitempty"`
}
...
type ItemList struct {
	SimpleItem []struct {
		...
		Name string `xml:"http://www.onvif.org/ver20/ptz/wsdl Name,attr,omitempty"`
...
type MessageDescription struct {
	...
	IsProperty bool `xml:"http://www.onvif.org/ver20/ptz/wsdl IsProperty,attr,omitempty"`
}
...
type ConfigDescription struct {
	...
	Messages []struct {
		*MessageDescription
		...
		//
		ParentTopic string `xml:"http://www.onvif.org/ver20/ptz/wsdl ParentTopic,omitempty"`
...
type PaneLayout struct {
	...
	Pane ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl Pane,omitempty"`
...
type Receiver struct {
	...
	Token ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl Token,omitempty"`
...
type VideoAttributes struct {
	...
	Encoding string `xml:"http://www.onvif.org/ver20/ptz/wsdl Encoding,omitempty"`
...
type MetadataAttributes struct {
	...
	CanContainPTZ bool `xml:"http://www.onvif.org/ver20/ptz/wsdl CanContainPTZ,omitempty"`

	// Indicates that there can be analytics data in the metadata track in the specified time interval.
	CanContainAnalytics bool `xml:"http://www.onvif.org/ver20/ptz/wsdl CanContainAnalytics,omitempty"`

	// Indicates that there can be notifications in the metadata track in the specified time interval.
	CanContainNotifications bool `xml:"http://www.onvif.org/ver20/ptz/wsdl CanContainNotifications,omitempty"`
...
type RecordingJobConfiguration struct {
	...
	ScheduleToken string `xml:"http://www.onvif.org/ver20/ptz/wsdl ScheduleToken,attr,omitempty"`
}
...
type RecordingJobSource struct {
	...
	AutoCreateReceiver bool `xml:"http://www.onvif.org/ver20/ptz/wsdl AutoCreateReceiver,omitempty"`
...
type RecordingJobTrack struct {
	...
	SourceTag string `xml:"http://www.onvif.org/ver20/ptz/wsdl SourceTag,omitempty"`
...
type OSDPosConfiguration struct {
	...
	//
	Type string `xml:"http://www.onvif.org/ver20/ptz/wsdl Type,omitempty"`
...
type OSDTextConfiguration struct {
	...
	//
	DateFormat string `xml:"http://www.onvif.org/ver20/ptz/wsdl DateFormat,omitempty"`
	...
	//
	TimeFormat string `xml:"http://www.onvif.org/ver20/ptz/wsdl TimeFormat,omitempty"`
	...
	PlainText string `xml:"http://www.onvif.org/ver20/ptz/wsdl PlainText,omitempty"`
	...
	IsPersistentText bool `xml:"http://www.onvif.org/ver20/ptz/wsdl IsPersistentText,attr,omitempty"`
}
...
type OSDConfigurationOptions struct {
	...
	//
	PositionOption []string `xml:"http://www.onvif.org/ver20/ptz/wsdl PositionOption,omitempty"`
...
type FileProgress struct {
	...
	// Exported file name
	FileName string `xml:"http://www.onvif.org/ver20/ptz/wsdl FileName,omitempty"`
...
type StorageReferencePath struct {
	...
	StorageToken ReferenceToken `xml:"http://www.onvif.org/ver20/ptz/wsdl StorageToken,omitempty"`

	// gives the relative directory path on the storage
	RelativePath string `xml:"http://www.onvif.org/ver20/ptz/wsdl RelativePath,omitempty"`
...
func NewPTZ(client *soap.Client, xaddr string) PTZ {
	return &pTZ{
		client: client,
		xaddr:  xaddr,
	}
