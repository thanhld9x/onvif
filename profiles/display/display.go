...
type GetServiceCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/display/wsdl GetServiceCapabilities"`
}
...
type GetLayout struct {
	...
	VideoOutput ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl VideoOutput,omitempty"`
}
...
type SetLayout struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/display/wsdl SetLayout"`

	// Token of the Video Output whose Layout shall be changed.
	VideoOutput ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl VideoOutput,omitempty"`

	// Layout to be set
	Layout Layout `xml:"http://www.onvif.org/ver10/display/wsdl Layout,omitempty"`
}

// SetLayoutResponse type
type SetLayoutResponse struct {
	XMLName xml.Name `xml:"SetLayoutResponse"`
}

// GetDisplayOptions type
type GetDisplayOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/display/wsdl GetDisplayOptions"`

	// Token of the Video Output whose options are requested
	VideoOutput ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl VideoOutput,omitempty"`
}

// GetDisplayOptionsResponse type
type GetDisplayOptionsResponse struct {
	...
	LayoutOptions LayoutOptions `xml:"LayoutOptions,omitempty"`

	// decoding and encoding capabilities of the device
	CodingCapabilities CodingCapabilities `xml:"CodingCapabilities,omitempty"`
}

// GetPaneConfigurations type
type GetPaneConfigurations struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/display/wsdl GetPaneConfigurations"`

	// Reference Token of the Video Output whose Pane Configurations are requested
	VideoOutput ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl VideoOutput,omitempty"`
}

// GetPaneConfigurationsResponse type
type GetPaneConfigurationsResponse struct {
	...
	PaneConfiguration []PaneConfiguration `xml:"PaneConfiguration,omitempty"`
}

// GetPaneConfiguration type
type GetPaneConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/display/wsdl GetPaneConfiguration"`
	...
	Pane ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl Pane,omitempty"`
}

// GetPaneConfigurationResponse type
...
// SetPaneConfigurations type
type SetPaneConfigurations struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/display/wsdl SetPaneConfigurations"`

	// Token of the video output whose panes to set.
	VideoOutput ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl VideoOutput,omitempty"`

	// Pane Configuration to be set.
	PaneConfiguration []PaneConfiguration `xml:"http://www.onvif.org/ver10/display/wsdl PaneConfiguration,omitempty"`
}

// SetPaneConfigurationsResponse type
type SetPaneConfigurationsResponse struct {
	XMLName xml.Name `xml:"SetPaneConfigurationsResponse"`
}

// SetPaneConfiguration type
type SetPaneConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/display/wsdl SetPaneConfiguration"`
...
// SetPaneConfigurationResponse type
type SetPaneConfigurationResponse struct {
	XMLName xml.Name `xml:"SetPaneConfigurationResponse"`
}

// CreatePaneConfiguration type
type CreatePaneConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/display/wsdl CreatePaneConfiguration"`
...
// CreatePaneConfigurationResponse type
type CreatePaneConfigurationResponse struct {
	...
	PaneToken ReferenceToken `xml:"PaneToken,omitempty"`
}

// DeletePaneConfiguration type
type DeletePaneConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/display/wsdl DeletePaneConfiguration"`

	// Token of the video output where the pane shall be deleted.
	VideoOutput ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl VideoOutput,omitempty"`

	// Token of the pane to be deleted.
	PaneToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl PaneToken,omitempty"`
}

// DeletePaneConfigurationResponse type
...
type Capabilities struct {
	...
	FixedLayout bool `xml:"http://www.onvif.org/ver10/display/wsdl FixedLayout,attr,omitempty"`
}
...
type VideoSourceConfiguration struct {
	*ConfigurationEntity
	...
	SourceToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl SourceToken,omitempty"`
...
type VideoSourceConfigurationOptions struct {
	...
	VideoSourceTokensAvailable []ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl VideoSourceTokensAvailable,omitempty"`
...
type RotateOptions struct {
	...
	Reboot bool `xml:"http://www.onvif.org/ver10/display/wsdl Reboot,attr,omitempty"`
}
...
type VideoEncoderConfiguration struct {
	*ConfigurationEntity
	...
	GuaranteedFrameRate bool `xml:"http://www.onvif.org/ver10/display/wsdl GuaranteedFrameRate,attr,omitempty"`
}
...
type MetadataConfiguration struct {
	*ConfigurationEntity
	...
	Analytics bool `xml:"http://www.onvif.org/ver10/display/wsdl Analytics,omitempty"`
	...
	GeoLocation bool `xml:"http://www.onvif.org/ver10/display/wsdl GeoLocation,attr,omitempty"`
}
...
type PTZFilter struct {
	...
	Status bool `xml:"http://www.onvif.org/ver10/display/wsdl Status,omitempty"`

	// True if the metadata stream shall contain the PTZ position
	Position bool `xml:"http://www.onvif.org/ver10/display/wsdl Position,omitempty"`
}
...
type PTZStatusFilterOptions struct {
	...
	PanTiltStatusSupported bool `xml:"http://www.onvif.org/ver10/display/wsdl PanTiltStatusSupported,omitempty"`

	// True if the device is able to stream zoom status inforamtion.
	ZoomStatusSupported bool `xml:"http://www.onvif.org/ver10/display/wsdl ZoomStatusSupported,omitempty"`

	// True if the device is able to stream the pan or tilt position.
	PanTiltPositionSupported bool `xml:"http://www.onvif.org/ver10/display/wsdl PanTiltPositionSupported,omitempty"`

	// True if the device is able to stream zoom position information.
	ZoomPositionSupported bool `xml:"http://www.onvif.org/ver10/display/wsdl ZoomPositionSupported,omitempty"`
...
type AudioOutputConfiguration struct {
	*ConfigurationEntity
	...
	OutputToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl OutputToken,omitempty"`
...
type MulticastConfiguration struct {
	...
	AutoStart bool `xml:"http://www.onvif.org/ver10/display/wsdl AutoStart,omitempty"`
}
...
type NetworkInterface struct {
	*DeviceEntity
	...
	Enabled bool `xml:"http://www.onvif.org/ver10/display/wsdl Enabled,omitempty"`
...
type NetworkInterfaceConnectionSetting struct {
	...
	AutoNegotiation bool `xml:"http://www.onvif.org/ver10/display/wsdl AutoNegotiation,omitempty"`
...
type IPv4Configuration struct {
	...
	DHCP bool `xml:"http://www.onvif.org/ver10/display/wsdl DHCP,omitempty"`
}
...
type IPv6Configuration struct {
	...
	AcceptRouterAdvert bool `xml:"http://www.onvif.org/ver10/display/wsdl AcceptRouterAdvert,omitempty"`
...
type HostnameInformation struct {
	...
	FromDHCP bool `xml:"http://www.onvif.org/ver10/display/wsdl FromDHCP,omitempty"`
...
type NetworkZeroConfiguration struct {
	...
	InterfaceToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl InterfaceToken,omitempty"`
...
type Dot11SecurityConfiguration struct {
	...
	Dot1X ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl Dot1X,omitempty"`
...
type AnalyticsCapabilities struct {
	...
	RuleSupport bool `xml:"http://www.onvif.org/ver10/display/wsdl RuleSupport,omitempty"`

	// Indicates whether or not modules are supported.
	AnalyticsModuleSupport bool `xml:"http://www.onvif.org/ver10/display/wsdl AnalyticsModuleSupport,omitempty"`
}
...
type EventCapabilities struct {
	...
	WSSubscriptionPolicySupport bool `xml:"http://www.onvif.org/ver10/display/wsdl WSSubscriptionPolicySupport,omitempty"`

	// Indicates whether or not WS Pull Point is supported.
	WSPullPointSupport bool `xml:"http://www.onvif.org/ver10/display/wsdl WSPullPointSupport,omitempty"`

	// Indicates whether or not WS Pausable Subscription Manager Interface is supported.
	WSPausableSubscriptionManagerInterfaceSupport bool `xml:"http://www.onvif.org/ver10/display/wsdl WSPausableSubscriptionManagerInterfaceSupport,omitempty"`
}
...
type IOCapabilitiesExtension struct {
	Auxiliary bool `xml:"http://www.onvif.org/ver10/display/wsdl Auxiliary,omitempty"`
...
type RealTimeStreamingCapabilities struct {
	...
	RTPMulticast bool `xml:"http://www.onvif.org/ver10/display/wsdl RTPMulticast,omitempty"`

	// Indicates whether or not RTP over TCP is supported.
	RTP_TCP bool `xml:"http://www.onvif.org/ver10/display/wsdl RTP_TCP,omitempty"`

	// Indicates whether or not RTP/RTSP/TCP is supported.
	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver10/display/wsdl RTP_RTSP_TCP,omitempty"`
...
type NetworkCapabilities struct {
	...
	IPFilter bool `xml:"http://www.onvif.org/ver10/display/wsdl IPFilter,omitempty"`

	// Indicates whether or not zeroconf is supported.
	ZeroConfiguration bool `xml:"http://www.onvif.org/ver10/display/wsdl ZeroConfiguration,omitempty"`

	// Indicates whether or not IPv6 is supported.
	IPVersion6 bool `xml:"http://www.onvif.org/ver10/display/wsdl IPVersion6,omitempty"`

	// Indicates whether or not  is supported.
	DynDNS bool `xml:"http://www.onvif.org/ver10/display/wsdl DynDNS,omitempty"`
...
type NetworkCapabilitiesExtension struct {
	Dot11Configuration bool `xml:"http://www.onvif.org/ver10/display/wsdl Dot11Configuration,omitempty"`
...
type SecurityCapabilities struct {
	...
	OnboardKeyGeneration bool `xml:"http://www.onvif.org/ver10/display/wsdl OnboardKeyGeneration,omitempty"`

	// Indicates whether or not access policy configuration is supported.
	AccessPolicyConfig bool `xml:"http://www.onvif.org/ver10/display/wsdl AccessPolicyConfig,omitempty"`
	...
	SAMLToken bool `xml:"http://www.onvif.org/ver10/display/wsdl SAMLToken,omitempty"`

	// Indicates whether or not WS-Security Kerberos token is supported.
	KerberosToken bool `xml:"http://www.onvif.org/ver10/display/wsdl KerberosToken,omitempty"`

	// Indicates whether or not WS-Security REL token is supported.
	RELToken bool `xml:"http://www.onvif.org/ver10/display/wsdl RELToken,omitempty"`
...
type SecurityCapabilitiesExtension2 struct {
	Dot1X bool `xml:"http://www.onvif.org/ver10/display/wsdl Dot1X,omitempty"`
	...
	RemoteUserHandling bool `xml:"http://www.onvif.org/ver10/display/wsdl RemoteUserHandling,omitempty"`
}
...
type SystemCapabilities struct {
	...
	DiscoveryResolve bool `xml:"http://www.onvif.org/ver10/display/wsdl DiscoveryResolve,omitempty"`

	// Indicates whether or not WS-Discovery Bye is supported.
	DiscoveryBye bool `xml:"http://www.onvif.org/ver10/display/wsdl DiscoveryBye,omitempty"`

	// Indicates whether or not remote discovery is supported.
	RemoteDiscovery bool `xml:"http://www.onvif.org/ver10/display/wsdl RemoteDiscovery,omitempty"`

	// Indicates whether or not system backup is supported.
	SystemBackup bool `xml:"http://www.onvif.org/ver10/display/wsdl SystemBackup,omitempty"`

	// Indicates whether or not system logging is supported.
	SystemLogging bool `xml:"http://www.onvif.org/ver10/display/wsdl SystemLogging,omitempty"`

	// Indicates whether or not firmware upgrade is supported.
	FirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/display/wsdl FirmwareUpgrade,omitempty"`
...
type SystemCapabilitiesExtension struct {
	HttpFirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/display/wsdl HttpFirmwareUpgrade,omitempty"`

	HttpSystemBackup bool `xml:"http://www.onvif.org/ver10/display/wsdl HttpSystemBackup,omitempty"`

	HttpSystemLogging bool `xml:"http://www.onvif.org/ver10/display/wsdl HttpSystemLogging,omitempty"`

	HttpSupportInformation bool `xml:"http://www.onvif.org/ver10/display/wsdl HttpSupportInformation,omitempty"`
...
type DisplayCapabilities struct {
	...
	// Indication that the SetLayout command supports only predefined layouts.
	FixedLayout bool `xml:"http://www.onvif.org/ver10/display/wsdl FixedLayout,omitempty"`
}
...
type RecordingCapabilities struct {
	...
	ReceiverSource bool `xml:"http://www.onvif.org/ver10/display/wsdl ReceiverSource,omitempty"`

	MediaProfileSource bool `xml:"http://www.onvif.org/ver10/display/wsdl MediaProfileSource,omitempty"`

	DynamicRecordings bool `xml:"http://www.onvif.org/ver10/display/wsdl DynamicRecordings,omitempty"`

	DynamicTracks bool `xml:"http://www.onvif.org/ver10/display/wsdl DynamicTracks,omitempty"`
...
type SearchCapabilities struct {
	...
	MetadataSearch bool `xml:"http://www.onvif.org/ver10/display/wsdl MetadataSearch,omitempty"`
}
...
type ReceiverCapabilities struct {
	...
	RTP_Multicast bool `xml:"http://www.onvif.org/ver10/display/wsdl RTP_Multicast,omitempty"`
...
type SystemDateTime struct {
	...
	DaylightSavings bool `xml:"http://www.onvif.org/ver10/display/wsdl DaylightSavings,omitempty"`
...
type CertificateUsage struct {
	...
	Critical bool `xml:"http://www.onvif.org/ver10/display/wsdl Critical,attr,omitempty"`
}
...
type Dot1XConfiguration struct {
	Dot1XConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl Dot1XConfigurationToken,omitempty"`
...
type PTZNode struct {
	*DeviceEntity
	...
	//
	HomeSupported bool `xml:"http://www.onvif.org/ver10/display/wsdl HomeSupported,omitempty"`
	...
	FixedHomePosition bool `xml:"http://www.onvif.org/ver10/display/wsdl FixedHomePosition,attr,omitempty"`

	//
	// Indication whether the Node supports the geo-referenced move command.
	//

	GeoMove bool `xml:"http://www.onvif.org/ver10/display/wsdl GeoMove,attr,omitempty"`
}
...
type PTZConfiguration struct {
	*ConfigurationEntity
	...
	//
	NodeToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl NodeToken,omitempty"`
...
type PTZPresetTourPresetDetail struct {
	...
	PresetToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl PresetToken,omitempty"`
	...
	Home bool `xml:"http://www.onvif.org/ver10/display/wsdl Home,omitempty"`
...
type PTZPresetTourStartingCondition struct {
	...
	RandomPresetOrder bool `xml:"http://www.onvif.org/ver10/display/wsdl RandomPresetOrder,attr,omitempty"`
}
...
type IrCutFilterAutoAdjustmentOptions struct {
	...
	BoundaryOffset bool `xml:"http://www.onvif.org/ver10/display/wsdl BoundaryOffset,omitempty"`
...
type ToneCompensationOptions struct {
	...
	Level bool `xml:"http://www.onvif.org/ver10/display/wsdl Level,omitempty"`
}
...
type MessageDescription struct {
	...
	IsProperty bool `xml:"http://www.onvif.org/ver10/display/wsdl IsProperty,attr,omitempty"`
}
...
// PaneConfiguration type
type PaneConfiguration struct {

	// Optional name of the pane configuration.
	PaneName string `xml:"http://www.onvif.org/ver10/schema PaneName,omitempty"`
	...
	AudioOutputToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl AudioOutputToken,omitempty"`
	...
	// DeviceIO service.
	AudioSourceToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl AudioSourceToken,omitempty"`
	...
	ReceiverToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl ReceiverToken,omitempty"`

	// A unique identifier in the display device.
	Token ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl Token,omitempty"`
}
...
type CodingCapabilities struct {
	...
	AudioEncodingCapabilities AudioEncoderConfigurationOptions `xml:"http://www.onvif.org/ver10/schema AudioEncodingCapabilities,omitempty"`

	// If the device supports audio decoding this section describes the supported codecs and their settings.
	AudioDecodingCapabilities AudioDecoderConfigurationOptions `xml:"http://www.onvif.org/ver10/schema AudioDecodingCapabilities,omitempty"`

	// This section describes the supported video codesc and their configuration.
	VideoDecodingCapabilities VideoDecoderConfigurationOptions `xml:"http://www.onvif.org/ver10/schema VideoDecodingCapabilities,omitempty"`
}
...
type MetadataAttributes struct {
	...
	CanContainPTZ bool `xml:"http://www.onvif.org/ver10/display/wsdl CanContainPTZ,omitempty"`

	// Indicates that there can be analytics data in the metadata track in the specified time interval.
	CanContainAnalytics bool `xml:"http://www.onvif.org/ver10/display/wsdl CanContainAnalytics,omitempty"`

	// Indicates that there can be notifications in the metadata track in the specified time interval.
	CanContainNotifications bool `xml:"http://www.onvif.org/ver10/display/wsdl CanContainNotifications,omitempty"`
...
type RecordingJobSource struct {
	...
	AutoCreateReceiver bool `xml:"http://www.onvif.org/ver10/display/wsdl AutoCreateReceiver,omitempty"`
...
type OSDTextConfiguration struct {
	...
	IsPersistentText bool `xml:"http://www.onvif.org/ver10/display/wsdl IsPersistentText,attr,omitempty"`
}
...
type StorageReferencePath struct {
	...
	StorageToken ReferenceToken `xml:"http://www.onvif.org/ver10/display/wsdl StorageToken,omitempty"`
...
type DisplayPort interface {
	...
	GetLayout(request *GetLayout) (*GetLayoutResponse, error)

	GetLayoutContext(ctx context.Context, request *GetLayout) (*GetLayoutResponse, error)
	...
	*/
	SetLayout(request *SetLayout) (*SetLayoutResponse, error)

	SetLayoutContext(ctx context.Context, request *SetLayout) (*SetLayoutResponse, error)
	...
	GetDisplayOptions(request *GetDisplayOptions) (*GetDisplayOptionsResponse, error)

	GetDisplayOptionsContext(ctx context.Context, request *GetDisplayOptions) (*GetDisplayOptionsResponse, error)
	...
	not be established. */
	GetPaneConfigurations(request *GetPaneConfigurations) (*GetPaneConfigurationsResponse, error)

	GetPaneConfigurationsContext(ctx context.Context, request *GetPaneConfigurations) (*GetPaneConfigurationsResponse, error)

	/* Retrieve the pane configuration for a pane token. */
	GetPaneConfiguration(request *GetPaneConfiguration) (*GetPaneConfigurationResponse, error)

	GetPaneConfigurationContext(ctx context.Context, request *GetPaneConfiguration) (*GetPaneConfigurationResponse, error)
	...
	SetPaneConfigurations(request *SetPaneConfigurations) (*SetPaneConfigurationsResponse, error)

	SetPaneConfigurationsContext(ctx context.Context, request *SetPaneConfigurations) (*SetPaneConfigurationsResponse, error)

	/* This command changes the configuration of the specified pane (tbd) */
	SetPaneConfiguration(request *SetPaneConfiguration) (*SetPaneConfigurationResponse, error)

	SetPaneConfigurationContext(ctx context.Context, request *SetPaneConfiguration) (*SetPaneConfigurationResponse, error)
	...
	*/
	CreatePaneConfiguration(request *CreatePaneConfiguration) (*CreatePaneConfigurationResponse, error)

	CreatePaneConfigurationContext(ctx context.Context, request *CreatePaneConfiguration) (*CreatePaneConfigurationResponse, error)
	...
	This optional method is only supported by devices that signal support of dynamic pane creation via their capabilities.
	*/
	DeletePaneConfiguration(request *DeletePaneConfiguration) (*DeletePaneConfigurationResponse, error)

	DeletePaneConfigurationContext(ctx context.Context, request *DeletePaneConfiguration) (*DeletePaneConfigurationResponse, error)
}
...
func NewDisplayPort(client *soap.Client, xaddr string) DisplayPort {
	return &displayPort{
		client: client,
		xaddr:  xaddr,
	}
...
func (service *displayPort) GetServiceCapabilities(request *GetServiceCapabilities) (*GetServiceCapabilitiesResponse, error) {
...
func (service *displayPort) GetLayout(request *GetLayout) (*GetLayoutResponse, error) {
	return service.GetLayoutContext(
		context.Background(),
		request,
	)
}
...
func (service *displayPort) SetLayout(request *SetLayout) (*SetLayoutResponse, error) {
	return service.SetLayoutContext(
		context.Background(),
		request,
	)
}
...
func (service *displayPort) GetDisplayOptions(request *GetDisplayOptions) (*GetDisplayOptionsResponse, error) {
	return service.GetDisplayOptionsContext(
		context.Background(),
		request,
	)
}
...
func (service *displayPort) GetPaneConfigurations(request *GetPaneConfigurations) (*GetPaneConfigurationsResponse, error) {
	return service.GetPaneConfigurationsContext(
		context.Background(),
		request,
	)
}
...
func (service *displayPort) GetPaneConfiguration(request *GetPaneConfiguration) (*GetPaneConfigurationResponse, error) {
	return service.GetPaneConfigurationContext(
		context.Background(),
		request,
	)
}
...
func (service *displayPort) SetPaneConfigurations(request *SetPaneConfigurations) (*SetPaneConfigurationsResponse, error) {
	return service.SetPaneConfigurationsContext(
		context.Background(),
		request,
	)
}
...
func (service *displayPort) SetPaneConfiguration(request *SetPaneConfiguration) (*SetPaneConfigurationResponse, error) {
	return service.SetPaneConfigurationContext(
		context.Background(),
		request,
	)
}
...
func (service *displayPort) CreatePaneConfiguration(request *CreatePaneConfiguration) (*CreatePaneConfigurationResponse, error) {
	return service.CreatePaneConfigurationContext(
		context.Background(),
		request,
	)
}
...
func (service *displayPort) DeletePaneConfiguration(request *DeletePaneConfiguration) (*DeletePaneConfigurationResponse, error) {
	return service.DeletePaneConfigurationContext(
		context.Background(),
		request,
	)
}
