...
// PanMove type
type PanMove struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/provisioning/wsdl PanMove"`

	// The video source associated with the provisioning.
	VideoSource ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl VideoSource,omitempty"`

	// "left" or "right".
	Direction PanDirection `xml:"http://www.onvif.org/ver10/provisioning/wsdl Direction,omitempty"`

	// "Operation timeout, if less than default timeout.
	Timeout Duration `xml:"http://www.onvif.org/ver10/schema Timeout,omitempty"`
}

// PanMoveResponse type
type PanMoveResponse struct {
	XMLName xml.Name `xml:"PanMoveResponse"`
}

// TiltMove type
type TiltMove struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/provisioning/wsdl TiltMove"`

	// The video source associated with the provisioning.
	VideoSource ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl VideoSource,omitempty"`

	// "up" or "down".
	Direction TiltDirection `xml:"http://www.onvif.org/ver10/provisioning/wsdl Direction,omitempty"`

	// "Operation timeout, if less than default timeout.
	Timeout Duration `xml:"http://www.onvif.org/ver10/schema Timeout,omitempty"`
}

// TiltMoveResponse type
type TiltMoveResponse struct {
	XMLName xml.Name `xml:"TiltMoveResponse"`
}

// ZoomMove type
type ZoomMove struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/provisioning/wsdl ZoomMove"`

	// The video source associated with the provisioning.
	VideoSource ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl VideoSource,omitempty"`

	// "wide" or "telephoto".
	Direction ZoomDirection `xml:"http://www.onvif.org/ver10/provisioning/wsdl Direction,omitempty"`

	// "Operation timeout, if less than default timeout.
	Timeout Duration `xml:"http://www.onvif.org/ver10/schema Timeout,omitempty"`
}

// ZoomMoveResponse type
type ZoomMoveResponse struct {
	XMLName xml.Name `xml:"ZoomMoveResponse"`
}

// RollMove type
type RollMove struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/provisioning/wsdl RollMove"`

	// The video source associated with the provisioning.
	VideoSource ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl VideoSource,omitempty"`

	// "clockwise", "counterclockwise", or "auto".
	Direction RollDirection `xml:"http://www.onvif.org/ver10/provisioning/wsdl Direction,omitempty"`

	// "Operation timeout, if less than default timeout.
	Timeout Duration `xml:"http://www.onvif.org/ver10/schema Timeout,omitempty"`
}

// RollMoveResponse type
type RollMoveResponse struct {
	XMLName xml.Name `xml:"RollMoveResponse"`
}
...
type FocusMove struct {
	...
	// "near", "far", or "auto".
	Direction FocusDirection `xml:"http://www.onvif.org/ver10/provisioning/wsdl Direction,omitempty"`

	// "Operation timeout, if less than default timeout.
	Timeout Duration `xml:"http://www.onvif.org/ver10/schema Timeout,omitempty"`
}

// FocusMoveResponse type
type FocusMoveResponse struct {
	XMLName xml.Name `xml:"FocusMoveResponse"`
}

// Stop type
type Stop struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/provisioning/wsdl Stop"`
...
type GetUsage struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/provisioning/wsdl GetUsage"`
...
type Usage struct {
	...
	Pan PositiveInteger `xml:"http://www.onvif.org/ver10/pacs Pan,omitempty"`

	// The quantity of tilt movement events over the life of the device.
	Tilt PositiveInteger `xml:"http://www.onvif.org/ver10/pacs Tilt,omitempty"`

	// The quantity of zoom movement events over the life of the device.
	Zoom PositiveInteger `xml:"http://www.onvif.org/ver10/pacs Zoom,omitempty"`

	// The quantity of roll movement events over the life of the device.
	Roll PositiveInteger `xml:"http://www.onvif.org/ver10/pacs Roll,omitempty"`

	// The quantity of focus movement events over the life of the device.
	Focus PositiveInteger `xml:"http://www.onvif.org/ver10/pacs Focus,omitempty"`
}

// SourceCapabilities type
type SourceCapabilities struct {

	// Unique identifier of a video source.

	VideoSourceToken ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl VideoSourceToken,attr,omitempty"`

	// Lifetime limit of pan moves for this video source.  Presence of this attribute indicates support of pan move.

	MaximumPanMoves PositiveInteger `xml:"http://www.onvif.org/ver10/pacs MaximumPanMoves,attr,omitempty"`

	// Lifetime limit of tilt moves for this video source.  Presence of this attribute indicates support of tilt move.

	MaximumTiltMoves PositiveInteger `xml:"http://www.onvif.org/ver10/pacs MaximumTiltMoves,attr,omitempty"`

	// Lifetime limit of zoom moves for this video source.  Presence of this attribute indicates support of zoom move.

	MaximumZoomMoves PositiveInteger `xml:"http://www.onvif.org/ver10/pacs MaximumZoomMoves,attr,omitempty"`

	// Lifetime limit of roll moves for this video source.  Presence of this attribute indicates support of roll move.

	MaximumRollMoves PositiveInteger `xml:"http://www.onvif.org/ver10/pacs MaximumRollMoves,attr,omitempty"`

	// Indicates "auto" as a valid enum for Direction in RollMove.

	AutoLevel bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl AutoLevel,attr,omitempty"`

	// Lifetime limit of focus moves for this video source.  Presence of this attribute indicates support of focus move.

	MaximumFocusMoves PositiveInteger `xml:"http://www.onvif.org/ver10/pacs MaximumFocusMoves,attr,omitempty"`

	// Indicates "auto" as a valid enum for Direction in FocusMove.

	AutoFocus bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl AutoFocus,attr,omitempty"`
}
...
type Capabilities struct {
	...
	DefaultTimeout Duration `xml:"http://www.onvif.org/ver10/schema DefaultTimeout,omitempty"`

	// Capabilities per video source.
	Source []SourceCapabilities `xml:"http://www.onvif.org/ver10/provisioning/wsdl Source,omitempty"`
}
...
type VideoSourceConfiguration struct {
	*ConfigurationEntity
	...
	SourceToken ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl SourceToken,omitempty"`
...
type VideoSourceConfigurationOptions struct {
	...
	VideoSourceTokensAvailable []ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl VideoSourceTokensAvailable,omitempty"`
...
type RotateOptions struct {
	...
	Reboot bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Reboot,attr,omitempty"`
}
...
type VideoEncoderConfiguration struct {
	*ConfigurationEntity
	...
	GuaranteedFrameRate bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl GuaranteedFrameRate,attr,omitempty"`
}
...
type MetadataConfiguration struct {
	*ConfigurationEntity
	...
	Analytics bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Analytics,omitempty"`
	...
	GeoLocation bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl GeoLocation,attr,omitempty"`
}
...
type PTZFilter struct {
	...
	Status bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Status,omitempty"`

	// True if the metadata stream shall contain the PTZ position
	Position bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Position,omitempty"`
}
...
type PTZStatusFilterOptions struct {
	...
	PanTiltStatusSupported bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl PanTiltStatusSupported,omitempty"`

	// True if the device is able to stream zoom status inforamtion.
	ZoomStatusSupported bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl ZoomStatusSupported,omitempty"`

	// True if the device is able to stream the pan or tilt position.
	PanTiltPositionSupported bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl PanTiltPositionSupported,omitempty"`

	// True if the device is able to stream zoom position information.
	ZoomPositionSupported bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl ZoomPositionSupported,omitempty"`
...
type AudioOutputConfiguration struct {
	*ConfigurationEntity
	...
	OutputToken ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl OutputToken,omitempty"`
...
type MulticastConfiguration struct {
	...
	AutoStart bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl AutoStart,omitempty"`
}
...
type NetworkInterface struct {
	*DeviceEntity
	...
	Enabled bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Enabled,omitempty"`
...
type NetworkInterfaceConnectionSetting struct {
	...
	AutoNegotiation bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl AutoNegotiation,omitempty"`
...
type IPv4Configuration struct {
	...
	DHCP bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl DHCP,omitempty"`
}
...
type IPv6Configuration struct {
	...
	AcceptRouterAdvert bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl AcceptRouterAdvert,omitempty"`
...
type HostnameInformation struct {
	...
	FromDHCP bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl FromDHCP,omitempty"`
...
type NetworkZeroConfiguration struct {
	...
	InterfaceToken ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl InterfaceToken,omitempty"`
...
type Dot11SecurityConfiguration struct {
	...
	Dot1X ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl Dot1X,omitempty"`
...
type AnalyticsCapabilities struct {
	...
	RuleSupport bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl RuleSupport,omitempty"`

	// Indicates whether or not modules are supported.
	AnalyticsModuleSupport bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl AnalyticsModuleSupport,omitempty"`
}
...
type EventCapabilities struct {
	...
	WSSubscriptionPolicySupport bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl WSSubscriptionPolicySupport,omitempty"`

	// Indicates whether or not WS Pull Point is supported.
	WSPullPointSupport bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl WSPullPointSupport,omitempty"`

	// Indicates whether or not WS Pausable Subscription Manager Interface is supported.
	WSPausableSubscriptionManagerInterfaceSupport bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl WSPausableSubscriptionManagerInterfaceSupport,omitempty"`
}
...
type IOCapabilitiesExtension struct {
	Auxiliary bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Auxiliary,omitempty"`
...
type RealTimeStreamingCapabilities struct {
	...
	RTPMulticast bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl RTPMulticast,omitempty"`

	// Indicates whether or not RTP over TCP is supported.
	RTP_TCP bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl RTP_TCP,omitempty"`

	// Indicates whether or not RTP/RTSP/TCP is supported.
	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl RTP_RTSP_TCP,omitempty"`
...
type NetworkCapabilities struct {
	...
	IPFilter bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl IPFilter,omitempty"`

	// Indicates whether or not zeroconf is supported.
	ZeroConfiguration bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl ZeroConfiguration,omitempty"`

	// Indicates whether or not IPv6 is supported.
	IPVersion6 bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl IPVersion6,omitempty"`

	// Indicates whether or not  is supported.
	DynDNS bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl DynDNS,omitempty"`
...
type NetworkCapabilitiesExtension struct {
	Dot11Configuration bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Dot11Configuration,omitempty"`
...
type SecurityCapabilities struct {
	...
	OnboardKeyGeneration bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl OnboardKeyGeneration,omitempty"`

	// Indicates whether or not access policy configuration is supported.
	AccessPolicyConfig bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl AccessPolicyConfig,omitempty"`
	...
	SAMLToken bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl SAMLToken,omitempty"`

	// Indicates whether or not WS-Security Kerberos token is supported.
	KerberosToken bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl KerberosToken,omitempty"`

	// Indicates whether or not WS-Security REL token is supported.
	RELToken bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl RELToken,omitempty"`
...
type SecurityCapabilitiesExtension2 struct {
	Dot1X bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Dot1X,omitempty"`
	...
	RemoteUserHandling bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl RemoteUserHandling,omitempty"`
}
...
type SystemCapabilities struct {
	...
	DiscoveryResolve bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl DiscoveryResolve,omitempty"`

	// Indicates whether or not WS-Discovery Bye is supported.
	DiscoveryBye bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl DiscoveryBye,omitempty"`

	// Indicates whether or not remote discovery is supported.
	RemoteDiscovery bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl RemoteDiscovery,omitempty"`

	// Indicates whether or not system backup is supported.
	SystemBackup bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl SystemBackup,omitempty"`

	// Indicates whether or not system logging is supported.
	SystemLogging bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl SystemLogging,omitempty"`

	// Indicates whether or not firmware upgrade is supported.
	FirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl FirmwareUpgrade,omitempty"`
...
type SystemCapabilitiesExtension struct {
	HttpFirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl HttpFirmwareUpgrade,omitempty"`

	HttpSystemBackup bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl HttpSystemBackup,omitempty"`

	HttpSystemLogging bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl HttpSystemLogging,omitempty"`

	HttpSupportInformation bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl HttpSupportInformation,omitempty"`
...
type DisplayCapabilities struct {
	...
	FixedLayout bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl FixedLayout,omitempty"`
}
...
type RecordingCapabilities struct {
	...
	ReceiverSource bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl ReceiverSource,omitempty"`

	MediaProfileSource bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl MediaProfileSource,omitempty"`

	DynamicRecordings bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl DynamicRecordings,omitempty"`

	DynamicTracks bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl DynamicTracks,omitempty"`
...
type SearchCapabilities struct {
	...
	MetadataSearch bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl MetadataSearch,omitempty"`
}
...
type ReceiverCapabilities struct {
	...
	RTP_Multicast bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl RTP_Multicast,omitempty"`
...
type SystemDateTime struct {
	...
	DaylightSavings bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl DaylightSavings,omitempty"`
...
type CertificateUsage struct {
	...
	Critical bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Critical,attr,omitempty"`
}
...
type Dot1XConfiguration struct {
	Dot1XConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl Dot1XConfigurationToken,omitempty"`
...
type PTZNode struct {
	*DeviceEntity
	...
	//
	HomeSupported bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl HomeSupported,omitempty"`
	...
	FixedHomePosition bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl FixedHomePosition,attr,omitempty"`

	//
	// Indication whether the Node supports the geo-referenced move command.
	//

	GeoMove bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl GeoMove,attr,omitempty"`
}
...
type PTZConfiguration struct {
	*ConfigurationEntity
	...
	//
	NodeToken ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl NodeToken,omitempty"`
...
type PTZPresetTourPresetDetail struct {
	...
	PresetToken ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl PresetToken,omitempty"`
	...
	Home bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Home,omitempty"`
...
type PTZPresetTourStartingCondition struct {
	...
	RandomPresetOrder bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl RandomPresetOrder,attr,omitempty"`
}
...
type IrCutFilterAutoAdjustmentOptions struct {
	...
	BoundaryOffset bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl BoundaryOffset,omitempty"`
...
type ToneCompensationOptions struct {
	...
	Level bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl Level,omitempty"`
}
...
type MessageDescription struct {
	...
	IsProperty bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl IsProperty,attr,omitempty"`
}
...
type PaneLayout struct {
	...
	Pane ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl Pane,omitempty"`
...
type Receiver struct {
	...
	Token ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl Token,omitempty"`
...
type MetadataAttributes struct {
	...
	CanContainPTZ bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl CanContainPTZ,omitempty"`

	// Indicates that there can be analytics data in the metadata track in the specified time interval.
	CanContainAnalytics bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl CanContainAnalytics,omitempty"`

	// Indicates that there can be notifications in the metadata track in the specified time interval.
	CanContainNotifications bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl CanContainNotifications,omitempty"`
...
type RecordingJobSource struct {
	...
	AutoCreateReceiver bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl AutoCreateReceiver,omitempty"`
...
type OSDTextConfiguration struct {
	...
	IsPersistentText bool `xml:"http://www.onvif.org/ver10/provisioning/wsdl IsPersistentText,attr,omitempty"`
}
...
type StorageReferencePath struct {
	...
	StorageToken ReferenceToken `xml:"http://www.onvif.org/ver10/provisioning/wsdl StorageToken,omitempty"`
...
type ProvisioningService interface {
	...
	PanMove(request *PanMove) (*PanMoveResponse, error)

	PanMoveContext(ctx context.Context, request *PanMove) (*PanMoveResponse, error)

	/* Moves device on the tilt axis. */
	TiltMove(request *TiltMove) (*TiltMoveResponse, error)

	TiltMoveContext(ctx context.Context, request *TiltMove) (*TiltMoveResponse, error)

	/* Moves device on the zoom axis. */
	ZoomMove(request *ZoomMove) (*ZoomMoveResponse, error)

	ZoomMoveContext(ctx context.Context, request *ZoomMove) (*ZoomMoveResponse, error)

	/* Moves device on the roll axis. */
	RollMove(request *RollMove) (*RollMoveResponse, error)

	RollMoveContext(ctx context.Context, request *RollMove) (*RollMoveResponse, error)

	/* Moves device on the focus axis. */
	FocusMove(request *FocusMove) (*FocusMoveResponse, error)

	FocusMoveContext(ctx context.Context, request *FocusMove) (*FocusMoveResponse, error)
	...
	GetUsage(request *GetUsage) (*GetUsageResponse, error)

	GetUsageContext(ctx context.Context, request *GetUsage) (*GetUsageResponse, error)
}
...
func NewProvisioningService(client *soap.Client, xaddr string) ProvisioningService {
...
func (service *provisioningService) GetServiceCapabilities(request *GetServiceCapabilities) (*GetServiceCapabilitiesResponse, error) {
...
func (service *provisioningService) PanMove(request *PanMove) (*PanMoveResponse, error) {
	return service.PanMoveContext(
		context.Background(),
		request,
	)
}
...
func (service *provisioningService) TiltMove(request *TiltMove) (*TiltMoveResponse, error) {
	return service.TiltMoveContext(
		context.Background(),
		request,
	)
}
...
func (service *provisioningService) ZoomMove(request *ZoomMove) (*ZoomMoveResponse, error) {
	return service.ZoomMoveContext(
		context.Background(),
		request,
	)
}
...
func (service *provisioningService) RollMove(request *RollMove) (*RollMoveResponse, error) {
	return service.RollMoveContext(
		context.Background(),
		request,
	)
}
...
func (service *provisioningService) FocusMove(request *FocusMove) (*FocusMoveResponse, error) {
	return service.FocusMoveContext(
		context.Background(),
		request,
	)
}
...
func (service *provisioningService) Stop(request *Stop) (*StopResponse, error) {
...
func (service *provisioningService) GetUsage(request *GetUsage) (*GetUsageResponse, error) {
	return service.GetUsageContext(
		context.Background(),
		request,
	)
}
