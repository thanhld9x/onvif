...
type GetServiceCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/replay/wsdl GetServiceCapabilities"`
}
...
type GetReplayUri struct {
	...
	StreamSetup StreamSetup `xml:"http://www.onvif.org/ver10/replay/wsdl StreamSetup,omitempty"`

	// The identifier of the recording to be streamed.
	RecordingToken ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl RecordingToken,omitempty"`
}
...
type SetReplayConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/replay/wsdl SetReplayConfiguration"`

	// Description of the new replay configuration parameters.
	Configuration ReplayConfiguration `xml:"http://www.onvif.org/ver10/replay/wsdl Configuration,omitempty"`
}
...
type GetReplayConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/replay/wsdl GetReplayConfiguration"`
}
...
type Capabilities struct {
	...
	ReversePlayback bool `xml:"http://www.onvif.org/ver10/replay/wsdl ReversePlayback,attr,omitempty"`

	// The list contains two elements defining the minimum and maximum valid values supported as session timeout in seconds.

	SessionTimeoutRange FloatAttrList `xml:"http://www.onvif.org/ver10/replay/wsdl SessionTimeoutRange,attr,omitempty"`

	// Indicates support for RTP/RTSP/TCP.

	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver10/replay/wsdl RTP_RTSP_TCP,attr,omitempty"`
...
type VideoSourceConfiguration struct {
	*ConfigurationEntity
	...
	SourceToken ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl SourceToken,omitempty"`
...
type VideoSourceConfigurationOptions struct {
	...
	VideoSourceTokensAvailable []ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl VideoSourceTokensAvailable,omitempty"`
...
type RotateOptions struct {
	...
	Reboot bool `xml:"http://www.onvif.org/ver10/replay/wsdl Reboot,attr,omitempty"`
}
...
type VideoEncoderConfiguration struct {
	*ConfigurationEntity
	...
	GuaranteedFrameRate bool `xml:"http://www.onvif.org/ver10/replay/wsdl GuaranteedFrameRate,attr,omitempty"`
}
...
type MetadataConfiguration struct {
	*ConfigurationEntity
	...
	Analytics bool `xml:"http://www.onvif.org/ver10/replay/wsdl Analytics,omitempty"`
	...
	GeoLocation bool `xml:"http://www.onvif.org/ver10/replay/wsdl GeoLocation,attr,omitempty"`
}
...
type PTZFilter struct {
	...
	Status bool `xml:"http://www.onvif.org/ver10/replay/wsdl Status,omitempty"`

	// True if the metadata stream shall contain the PTZ position
	Position bool `xml:"http://www.onvif.org/ver10/replay/wsdl Position,omitempty"`
}
...
type PTZStatusFilterOptions struct {
	...
	PanTiltStatusSupported bool `xml:"http://www.onvif.org/ver10/replay/wsdl PanTiltStatusSupported,omitempty"`

	// True if the device is able to stream zoom status inforamtion.
	ZoomStatusSupported bool `xml:"http://www.onvif.org/ver10/replay/wsdl ZoomStatusSupported,omitempty"`

	// True if the device is able to stream the pan or tilt position.
	PanTiltPositionSupported bool `xml:"http://www.onvif.org/ver10/replay/wsdl PanTiltPositionSupported,omitempty"`

	// True if the device is able to stream zoom position information.
	ZoomPositionSupported bool `xml:"http://www.onvif.org/ver10/replay/wsdl ZoomPositionSupported,omitempty"`
...
type AudioOutputConfiguration struct {
	*ConfigurationEntity
	...
	OutputToken ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl OutputToken,omitempty"`
...
type MulticastConfiguration struct {
	...
	AutoStart bool `xml:"http://www.onvif.org/ver10/replay/wsdl AutoStart,omitempty"`
}
...
type NetworkInterface struct {
	*DeviceEntity
	...
	Enabled bool `xml:"http://www.onvif.org/ver10/replay/wsdl Enabled,omitempty"`
...
type NetworkInterfaceConnectionSetting struct {
	...
	AutoNegotiation bool `xml:"http://www.onvif.org/ver10/replay/wsdl AutoNegotiation,omitempty"`
...
type IPv4Configuration struct {
	...
	DHCP bool `xml:"http://www.onvif.org/ver10/replay/wsdl DHCP,omitempty"`
}
...
type IPv6Configuration struct {
	...
	AcceptRouterAdvert bool `xml:"http://www.onvif.org/ver10/replay/wsdl AcceptRouterAdvert,omitempty"`
...
type HostnameInformation struct {
	...
	FromDHCP bool `xml:"http://www.onvif.org/ver10/replay/wsdl FromDHCP,omitempty"`
...
type NetworkZeroConfiguration struct {
	...
	InterfaceToken ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl InterfaceToken,omitempty"`
...
type Dot11SecurityConfiguration struct {
	...
	Dot1X ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl Dot1X,omitempty"`
...
type AnalyticsCapabilities struct {
	...
	RuleSupport bool `xml:"http://www.onvif.org/ver10/replay/wsdl RuleSupport,omitempty"`

	// Indicates whether or not modules are supported.
	AnalyticsModuleSupport bool `xml:"http://www.onvif.org/ver10/replay/wsdl AnalyticsModuleSupport,omitempty"`
}
...
type EventCapabilities struct {
	...
	WSSubscriptionPolicySupport bool `xml:"http://www.onvif.org/ver10/replay/wsdl WSSubscriptionPolicySupport,omitempty"`

	// Indicates whether or not WS Pull Point is supported.
	WSPullPointSupport bool `xml:"http://www.onvif.org/ver10/replay/wsdl WSPullPointSupport,omitempty"`

	// Indicates whether or not WS Pausable Subscription Manager Interface is supported.
	WSPausableSubscriptionManagerInterfaceSupport bool `xml:"http://www.onvif.org/ver10/replay/wsdl WSPausableSubscriptionManagerInterfaceSupport,omitempty"`
}
...
type IOCapabilitiesExtension struct {
	Auxiliary bool `xml:"http://www.onvif.org/ver10/replay/wsdl Auxiliary,omitempty"`
...
type RealTimeStreamingCapabilities struct {
	...
	RTPMulticast bool `xml:"http://www.onvif.org/ver10/replay/wsdl RTPMulticast,omitempty"`

	// Indicates whether or not RTP over TCP is supported.
	RTP_TCP bool `xml:"http://www.onvif.org/ver10/replay/wsdl RTP_TCP,omitempty"`

	// Indicates whether or not RTP/RTSP/TCP is supported.
	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver10/replay/wsdl RTP_RTSP_TCP,omitempty"`
...
type NetworkCapabilities struct {
	...
	IPFilter bool `xml:"http://www.onvif.org/ver10/replay/wsdl IPFilter,omitempty"`

	// Indicates whether or not zeroconf is supported.
	ZeroConfiguration bool `xml:"http://www.onvif.org/ver10/replay/wsdl ZeroConfiguration,omitempty"`

	// Indicates whether or not IPv6 is supported.
	IPVersion6 bool `xml:"http://www.onvif.org/ver10/replay/wsdl IPVersion6,omitempty"`

	// Indicates whether or not  is supported.
	DynDNS bool `xml:"http://www.onvif.org/ver10/replay/wsdl DynDNS,omitempty"`
...
type NetworkCapabilitiesExtension struct {
	Dot11Configuration bool `xml:"http://www.onvif.org/ver10/replay/wsdl Dot11Configuration,omitempty"`
...
type SecurityCapabilities struct {
	...
	OnboardKeyGeneration bool `xml:"http://www.onvif.org/ver10/replay/wsdl OnboardKeyGeneration,omitempty"`

	// Indicates whether or not access policy configuration is supported.
	AccessPolicyConfig bool `xml:"http://www.onvif.org/ver10/replay/wsdl AccessPolicyConfig,omitempty"`
	...
	SAMLToken bool `xml:"http://www.onvif.org/ver10/replay/wsdl SAMLToken,omitempty"`

	// Indicates whether or not WS-Security Kerberos token is supported.
	KerberosToken bool `xml:"http://www.onvif.org/ver10/replay/wsdl KerberosToken,omitempty"`

	// Indicates whether or not WS-Security REL token is supported.
	RELToken bool `xml:"http://www.onvif.org/ver10/replay/wsdl RELToken,omitempty"`
...
type SecurityCapabilitiesExtension2 struct {
	Dot1X bool `xml:"http://www.onvif.org/ver10/replay/wsdl Dot1X,omitempty"`
	...
	RemoteUserHandling bool `xml:"http://www.onvif.org/ver10/replay/wsdl RemoteUserHandling,omitempty"`
}
...
type SystemCapabilities struct {
	...
	DiscoveryResolve bool `xml:"http://www.onvif.org/ver10/replay/wsdl DiscoveryResolve,omitempty"`

	// Indicates whether or not WS-Discovery Bye is supported.
	DiscoveryBye bool `xml:"http://www.onvif.org/ver10/replay/wsdl DiscoveryBye,omitempty"`

	// Indicates whether or not remote discovery is supported.
	RemoteDiscovery bool `xml:"http://www.onvif.org/ver10/replay/wsdl RemoteDiscovery,omitempty"`

	// Indicates whether or not system backup is supported.
	SystemBackup bool `xml:"http://www.onvif.org/ver10/replay/wsdl SystemBackup,omitempty"`

	// Indicates whether or not system logging is supported.
	SystemLogging bool `xml:"http://www.onvif.org/ver10/replay/wsdl SystemLogging,omitempty"`

	// Indicates whether or not firmware upgrade is supported.
	FirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/replay/wsdl FirmwareUpgrade,omitempty"`
...
type SystemCapabilitiesExtension struct {
	HttpFirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/replay/wsdl HttpFirmwareUpgrade,omitempty"`

	HttpSystemBackup bool `xml:"http://www.onvif.org/ver10/replay/wsdl HttpSystemBackup,omitempty"`

	HttpSystemLogging bool `xml:"http://www.onvif.org/ver10/replay/wsdl HttpSystemLogging,omitempty"`

	HttpSupportInformation bool `xml:"http://www.onvif.org/ver10/replay/wsdl HttpSupportInformation,omitempty"`
...
type DisplayCapabilities struct {
	...
	FixedLayout bool `xml:"http://www.onvif.org/ver10/replay/wsdl FixedLayout,omitempty"`
}
...
type RecordingCapabilities struct {
	...
	ReceiverSource bool `xml:"http://www.onvif.org/ver10/replay/wsdl ReceiverSource,omitempty"`

	MediaProfileSource bool `xml:"http://www.onvif.org/ver10/replay/wsdl MediaProfileSource,omitempty"`

	DynamicRecordings bool `xml:"http://www.onvif.org/ver10/replay/wsdl DynamicRecordings,omitempty"`

	DynamicTracks bool `xml:"http://www.onvif.org/ver10/replay/wsdl DynamicTracks,omitempty"`
...
type SearchCapabilities struct {
	...
	MetadataSearch bool `xml:"http://www.onvif.org/ver10/replay/wsdl MetadataSearch,omitempty"`
}
...
type ReceiverCapabilities struct {
	...
	RTP_Multicast bool `xml:"http://www.onvif.org/ver10/replay/wsdl RTP_Multicast,omitempty"`
...
type SystemDateTime struct {
	...
	DaylightSavings bool `xml:"http://www.onvif.org/ver10/replay/wsdl DaylightSavings,omitempty"`
...
type CertificateUsage struct {
	...
	Critical bool `xml:"http://www.onvif.org/ver10/replay/wsdl Critical,attr,omitempty"`
}
...
type Dot1XConfiguration struct {
	Dot1XConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl Dot1XConfigurationToken,omitempty"`
...
type PTZNode struct {
	*DeviceEntity
	...
	//
	HomeSupported bool `xml:"http://www.onvif.org/ver10/replay/wsdl HomeSupported,omitempty"`
	...
	FixedHomePosition bool `xml:"http://www.onvif.org/ver10/replay/wsdl FixedHomePosition,attr,omitempty"`

	//
	// Indication whether the Node supports the geo-referenced move command.
	//

	GeoMove bool `xml:"http://www.onvif.org/ver10/replay/wsdl GeoMove,attr,omitempty"`
}
...
type PTZConfiguration struct {
	*ConfigurationEntity
	...
	//
	NodeToken ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl NodeToken,omitempty"`
...
type PTZPresetTourPresetDetail struct {
	...
	PresetToken ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl PresetToken,omitempty"`
	...
	Home bool `xml:"http://www.onvif.org/ver10/replay/wsdl Home,omitempty"`
...
type PTZPresetTourStartingCondition struct {
	...
	RandomPresetOrder bool `xml:"http://www.onvif.org/ver10/replay/wsdl RandomPresetOrder,attr,omitempty"`
}
...
type IrCutFilterAutoAdjustmentOptions struct {
	...
	BoundaryOffset bool `xml:"http://www.onvif.org/ver10/replay/wsdl BoundaryOffset,omitempty"`
...
type ToneCompensationOptions struct {
	...
	Level bool `xml:"http://www.onvif.org/ver10/replay/wsdl Level,omitempty"`
}
...
type MessageDescription struct {
	...
	IsProperty bool `xml:"http://www.onvif.org/ver10/replay/wsdl IsProperty,attr,omitempty"`
}
...
type PaneLayout struct {
	...
	Pane ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl Pane,omitempty"`
...
type Receiver struct {
	...
	Token ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl Token,omitempty"`
...
type MetadataAttributes struct {
	...
	CanContainPTZ bool `xml:"http://www.onvif.org/ver10/replay/wsdl CanContainPTZ,omitempty"`

	// Indicates that there can be analytics data in the metadata track in the specified time interval.
	CanContainAnalytics bool `xml:"http://www.onvif.org/ver10/replay/wsdl CanContainAnalytics,omitempty"`

	// Indicates that there can be notifications in the metadata track in the specified time interval.
	CanContainNotifications bool `xml:"http://www.onvif.org/ver10/replay/wsdl CanContainNotifications,omitempty"`
...
type RecordingJobSource struct {
	...
	AutoCreateReceiver bool `xml:"http://www.onvif.org/ver10/replay/wsdl AutoCreateReceiver,omitempty"`
...
type OSDTextConfiguration struct {
	...
	IsPersistentText bool `xml:"http://www.onvif.org/ver10/replay/wsdl IsPersistentText,attr,omitempty"`
}
...
type StorageReferencePath struct {
	...
	StorageToken ReferenceToken `xml:"http://www.onvif.org/ver10/replay/wsdl StorageToken,omitempty"`
...
type ReplayPort interface {
	...
	*/
	GetReplayUri(request *GetReplayUri) (*GetReplayUriResponse, error)

	GetReplayUriContext(ctx context.Context, request *GetReplayUri) (*GetReplayUriResponse, error)

	/*
		Returns the current configuration of the replay service.
		This operation is mandatory.
	*/
	GetReplayConfiguration(request *GetReplayConfiguration) (*GetReplayConfigurationResponse, error)

	GetReplayConfigurationContext(ctx context.Context, request *GetReplayConfiguration) (*GetReplayConfigurationResponse, error)

	/*
		Changes the current configuration of the replay service.
		This operation is mandatory.
	*/
	SetReplayConfiguration(request *SetReplayConfiguration) (*SetReplayConfigurationResponse, error)

	SetReplayConfigurationContext(ctx context.Context, request *SetReplayConfiguration) (*SetReplayConfigurationResponse, error)
}
...
func NewReplayPort(client *soap.Client, xaddr string) ReplayPort {
	return &replayPort{
		client: client,
		xaddr:  xaddr,
	}
...
func (service *replayPort) GetServiceCapabilitiesContext(ctx context.Context, request *GetServiceCapabilities) (*GetServiceCapabilitiesResponse, error) {
	response := new(GetServiceCapabilitiesResponse)
	err := service.client.CallContext(ctx, service.xaddr, "http://www.onvif.org/ver10/replay/wsdl/GetServiceCapabilities", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *replayPort) GetServiceCapabilities(request *GetServiceCapabilities) (*GetServiceCapabilitiesResponse, error) {
...
func (service *replayPort) GetReplayUriContext(ctx context.Context, request *GetReplayUri) (*GetReplayUriResponse, error) {
	response := new(GetReplayUriResponse)
	err := service.client.CallContext(ctx, service.xaddr, "http://www.onvif.org/ver10/replay/wsdl/GetReplayUri", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *replayPort) GetReplayUri(request *GetReplayUri) (*GetReplayUriResponse, error) {
	return service.GetReplayUriContext(
		context.Background(),
		request,
	)
}

func (service *replayPort) GetReplayConfigurationContext(ctx context.Context, request *GetReplayConfiguration) (*GetReplayConfigurationResponse, error) {
	response := new(GetReplayConfigurationResponse)
	err := service.client.CallContext(ctx, service.xaddr, "http://www.onvif.org/ver10/replay/wsdl/GetReplayConfiguration", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *replayPort) GetReplayConfiguration(request *GetReplayConfiguration) (*GetReplayConfigurationResponse, error) {
	return service.GetReplayConfigurationContext(
		context.Background(),
		request,
	)
}

func (service *replayPort) SetReplayConfigurationContext(ctx context.Context, request *SetReplayConfiguration) (*SetReplayConfigurationResponse, error) {
	response := new(SetReplayConfigurationResponse)
	err := service.client.CallContext(ctx, service.xaddr, "http://www.onvif.org/ver10/replay/wsdl/SetReplayConfiguration", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *replayPort) SetReplayConfiguration(request *SetReplayConfiguration) (*SetReplayConfigurationResponse, error) {
	return service.SetReplayConfigurationContext(
		context.Background(),
		request,
	)
}
