...
type GetServiceCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl GetServiceCapabilities"`
}
...
type GetSupportedRules struct {
	...
	//
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`
}

// GetSupportedRulesResponse type
type GetSupportedRulesResponse struct {
	XMLName xml.Name `xml:"GetSupportedRulesResponse"`

	SupportedRules SupportedRules `xml:"SupportedRules,omitempty"`
}

// CreateRules type
type CreateRules struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl CreateRules"`

	// Reference to an existing VideoAnalyticsConfiguration.
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`

	Rule []Config `xml:"http://www.onvif.org/ver20/analytics/wsdl Rule,omitempty"`
}

// CreateRulesResponse type
type CreateRulesResponse struct {
	XMLName xml.Name `xml:"CreateRulesResponse"`
}

// DeleteRules type
type DeleteRules struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl DeleteRules"`

	// Reference to an existing VideoAnalyticsConfiguration.
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`

	// References the specific rule to be deleted (e.g. "MyLineDetector").
	RuleName []string `xml:"http://www.onvif.org/ver20/analytics/wsdl RuleName,omitempty"`
}

// DeleteRulesResponse type
type DeleteRulesResponse struct {
	XMLName xml.Name `xml:"DeleteRulesResponse"`
}

// ModifyRules type
type ModifyRules struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl ModifyRules"`
...
// ModifyRulesResponse type
type ModifyRulesResponse struct {
	XMLName xml.Name `xml:"ModifyRulesResponse"`
}

// GetRules type
type GetRules struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl GetRules"`

	// Reference to an existing VideoAnalyticsConfiguration.
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`
}

// GetRulesResponse type
...
type GetRuleOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl GetRuleOptions"`

	// Reference to an SupportedRule Type returned from GetSupportedRules.
	RuleType QName `xml:"http://www.onvif.org/ver20/analytics/wsdl RuleType,omitempty"`

	// Reference to an existing analytics configuration.
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`
}

// GetRuleOptionsResponse type
...
// GetSupportedAnalyticsModules type
type GetSupportedAnalyticsModules struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl GetSupportedAnalyticsModules"`

	// Reference to an existing VideoAnalyticsConfiguration.
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`
}

// GetSupportedAnalyticsModulesResponse type
type GetSupportedAnalyticsModulesResponse struct {
	XMLName xml.Name `xml:"GetSupportedAnalyticsModulesResponse"`

	SupportedAnalyticsModules SupportedAnalyticsModules `xml:"SupportedAnalyticsModules,omitempty"`
}

// CreateAnalyticsModules type
type CreateAnalyticsModules struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl CreateAnalyticsModules"`

	// Reference to an existing VideoAnalyticsConfiguration.
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`

	AnalyticsModule []Config `xml:"http://www.onvif.org/ver20/analytics/wsdl AnalyticsModule,omitempty"`
}

// CreateAnalyticsModulesResponse type
type CreateAnalyticsModulesResponse struct {
	XMLName xml.Name `xml:"CreateAnalyticsModulesResponse"`
}

// DeleteAnalyticsModules type
type DeleteAnalyticsModules struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl DeleteAnalyticsModules"`

	// Reference to an existing Video Analytics configuration.
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`

	// Name of the AnalyticsModule to be deleted.
	AnalyticsModuleName []string `xml:"http://www.onvif.org/ver20/analytics/wsdl AnalyticsModuleName,omitempty"`
}

// DeleteAnalyticsModulesResponse type
type DeleteAnalyticsModulesResponse struct {
	XMLName xml.Name `xml:"DeleteAnalyticsModulesResponse"`
}

// ModifyAnalyticsModules type
type ModifyAnalyticsModules struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl ModifyAnalyticsModules"`
...
// ModifyAnalyticsModulesResponse type
type ModifyAnalyticsModulesResponse struct {
	XMLName xml.Name `xml:"ModifyAnalyticsModulesResponse"`
}

// GetAnalyticsModules type
type GetAnalyticsModules struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl GetAnalyticsModules"`

	// Reference to an existing VideoAnalyticsConfiguration.
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`
}

// GetAnalyticsModulesResponse type
...
// GetAnalyticsModuleOptions type
type GetAnalyticsModuleOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/analytics/wsdl GetAnalyticsModuleOptions"`

	// Reference to an SupportedAnalyticsModule Type returned from GetSupportedAnalyticsModules.
	Type QName `xml:"http://www.onvif.org/ver20/analytics/wsdl Type,omitempty"`

	// Reference to an existing AnalyticsConfiguration.
	ConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl ConfigurationToken,omitempty"`
}

// GetAnalyticsModuleOptionsResponse type
...
type Capabilities struct {
	...
	RuleSupport bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RuleSupport,attr,omitempty"`

	// Indication that the device supports the scene analytics module interface.

	AnalyticsModuleSupport bool `xml:"http://www.onvif.org/ver20/analytics/wsdl AnalyticsModuleSupport,attr,omitempty"`

	// Indication that the device produces the cell based scene description

	CellBasedSceneDescriptionSupported bool `xml:"http://www.onvif.org/ver20/analytics/wsdl CellBasedSceneDescriptionSupported,attr,omitempty"`

	// Indication that the device supports the GetRuleOptions operation on the rules interface

	RuleOptionsSupported bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RuleOptionsSupported,attr,omitempty"`

	// Indication that the device supports the GetAnalyticsModuleOptions operation on the analytics interface

	AnalyticsModuleOptionsSupported bool `xml:"http://www.onvif.org/ver20/analytics/wsdl AnalyticsModuleOptionsSupported,attr,omitempty"`
}
...
type ConfigOptions struct {
	...
	RuleType QName `xml:"http://www.onvif.org/ver20/analytics/wsdl RuleType,attr,omitempty"`
	...
	Name string `xml:"http://www.onvif.org/ver20/analytics/wsdl Name,attr,omitempty"`
	...
	Type QName `xml:"http://www.onvif.org/ver20/analytics/wsdl Type,attr,omitempty"`
	...
	AnalyticsModule QName `xml:"http://www.onvif.org/ver20/analytics/wsdl AnalyticsModule,attr,omitempty"`
}
...
type Subcode struct {
	...
	Value QName `xml:"http://www.onvif.org/ver20/analytics/wsdl Value,omitempty"`
...
type InvalidFilterFaultType struct {
	...
	*BaseFaultType
	...
	UnknownFilter []QName `xml:"http://www.onvif.org/ver20/analytics/wsdl UnknownFilter,omitempty"`
}
...
type UnrecognizedPolicyRequestFaultType struct {
	...
	*BaseFaultType
	...
	UnrecognizedPolicy []QName `xml:"http://www.onvif.org/ver20/analytics/wsdl UnrecognizedPolicy,omitempty"`
}
...
type UnsupportedPolicyRequestFaultType struct {
	...
	*BaseFaultType
	...
	UnsupportedPolicy []QName `xml:"http://www.onvif.org/ver20/analytics/wsdl UnsupportedPolicy,omitempty"`
}
...
type PTZStatus struct {
	...
	//
	Error string `xml:"http://www.onvif.org/ver20/analytics/wsdl Error,omitempty"`
...
type VideoSourceConfiguration struct {
	*ConfigurationEntity
	...
	SourceToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl SourceToken,omitempty"`
	...
	ViewMode string `xml:"http://www.onvif.org/ver20/analytics/wsdl ViewMode,attr,omitempty"`
}
...
type VideoSourceConfigurationOptions struct {
	...
	VideoSourceTokensAvailable []ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl VideoSourceTokensAvailable,omitempty"`
...
type RotateOptions struct {
	...
	Reboot bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Reboot,attr,omitempty"`
}
...
type SceneOrientation struct {
	...
	//
	Orientation string `xml:"http://www.onvif.org/ver20/analytics/wsdl Orientation,omitempty"`
}
...
type VideoEncoderConfiguration struct {
	*ConfigurationEntity
	...
	GuaranteedFrameRate bool `xml:"http://www.onvif.org/ver20/analytics/wsdl GuaranteedFrameRate,attr,omitempty"`
}
...
type MetadataConfiguration struct {
	*ConfigurationEntity
	...
	Analytics bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Analytics,omitempty"`
	...
	CompressionType string `xml:"http://www.onvif.org/ver20/analytics/wsdl CompressionType,attr,omitempty"`

	// Optional parameter to configure if the metadata stream shall contain the Geo Location coordinates of each target.

	GeoLocation bool `xml:"http://www.onvif.org/ver20/analytics/wsdl GeoLocation,attr,omitempty"`
}
...
type PTZFilter struct {
	...
	Status bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Status,omitempty"`

	// True if the metadata stream shall contain the PTZ position
	Position bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Position,omitempty"`
}
...
type MetadataConfigurationOptionsExtension struct {
	...
	CompressionType []string `xml:"http://www.onvif.org/ver20/analytics/wsdl CompressionType,omitempty"`
...
type PTZStatusFilterOptions struct {
	...
	PanTiltStatusSupported bool `xml:"http://www.onvif.org/ver20/analytics/wsdl PanTiltStatusSupported,omitempty"`

	// True if the device is able to stream zoom status inforamtion.
	ZoomStatusSupported bool `xml:"http://www.onvif.org/ver20/analytics/wsdl ZoomStatusSupported,omitempty"`

	// True if the device is able to stream the pan or tilt position.
	PanTiltPositionSupported bool `xml:"http://www.onvif.org/ver20/analytics/wsdl PanTiltPositionSupported,omitempty"`

	// True if the device is able to stream zoom position information.
	ZoomPositionSupported bool `xml:"http://www.onvif.org/ver20/analytics/wsdl ZoomPositionSupported,omitempty"`
...
type AudioOutputConfiguration struct {
	*ConfigurationEntity
	...
	OutputToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl OutputToken,omitempty"`
...
type MulticastConfiguration struct {
	...
	AutoStart bool `xml:"http://www.onvif.org/ver20/analytics/wsdl AutoStart,omitempty"`
}
...
type NetworkInterface struct {
	*DeviceEntity
	...
	Enabled bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Enabled,omitempty"`
...
type NetworkInterfaceConnectionSetting struct {
	...
	AutoNegotiation bool `xml:"http://www.onvif.org/ver20/analytics/wsdl AutoNegotiation,omitempty"`
...
type NetworkInterfaceInfo struct {
	...
	Name string `xml:"http://www.onvif.org/ver20/analytics/wsdl Name,omitempty"`
...
type IPv4Configuration struct {
	...
	DHCP bool `xml:"http://www.onvif.org/ver20/analytics/wsdl DHCP,omitempty"`
}
...
type IPv6Configuration struct {
	...
	AcceptRouterAdvert bool `xml:"http://www.onvif.org/ver20/analytics/wsdl AcceptRouterAdvert,omitempty"`
...
type HostnameInformation struct {
	...
	FromDHCP bool `xml:"http://www.onvif.org/ver20/analytics/wsdl FromDHCP,omitempty"`
...
type DNSInformation struct {
	...
	// Search domain.
	SearchDomain []string `xml:"http://www.onvif.org/ver20/analytics/wsdl SearchDomain,omitempty"`
...
type NetworkZeroConfiguration struct {
	...
	InterfaceToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl InterfaceToken,omitempty"`
...
type Dot11SecurityConfiguration struct {
	...
	Dot1X ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl Dot1X,omitempty"`
...
type Dot11AvailableNetworks struct {
	...
	BSSID string `xml:"http://www.onvif.org/ver20/analytics/wsdl BSSID,omitempty"`
...
type AnalyticsCapabilities struct {
	...
	RuleSupport bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RuleSupport,omitempty"`

	// Indicates whether or not modules are supported.
	AnalyticsModuleSupport bool `xml:"http://www.onvif.org/ver20/analytics/wsdl AnalyticsModuleSupport,omitempty"`
}
...
type EventCapabilities struct {
	...
	WSSubscriptionPolicySupport bool `xml:"http://www.onvif.org/ver20/analytics/wsdl WSSubscriptionPolicySupport,omitempty"`

	// Indicates whether or not WS Pull Point is supported.
	WSPullPointSupport bool `xml:"http://www.onvif.org/ver20/analytics/wsdl WSPullPointSupport,omitempty"`

	// Indicates whether or not WS Pausable Subscription Manager Interface is supported.
	WSPausableSubscriptionManagerInterfaceSupport bool `xml:"http://www.onvif.org/ver20/analytics/wsdl WSPausableSubscriptionManagerInterfaceSupport,omitempty"`
}
...
type IOCapabilitiesExtension struct {
	Auxiliary bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Auxiliary,omitempty"`
...
type RealTimeStreamingCapabilities struct {
	...
	RTPMulticast bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RTPMulticast,omitempty"`

	// Indicates whether or not RTP over TCP is supported.
	RTP_TCP bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RTP_TCP,omitempty"`

	// Indicates whether or not RTP/RTSP/TCP is supported.
	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RTP_RTSP_TCP,omitempty"`
...
type NetworkCapabilities struct {
	...
	IPFilter bool `xml:"http://www.onvif.org/ver20/analytics/wsdl IPFilter,omitempty"`

	// Indicates whether or not zeroconf is supported.
	ZeroConfiguration bool `xml:"http://www.onvif.org/ver20/analytics/wsdl ZeroConfiguration,omitempty"`

	// Indicates whether or not IPv6 is supported.
	IPVersion6 bool `xml:"http://www.onvif.org/ver20/analytics/wsdl IPVersion6,omitempty"`

	// Indicates whether or not  is supported.
	DynDNS bool `xml:"http://www.onvif.org/ver20/analytics/wsdl DynDNS,omitempty"`
...
type NetworkCapabilitiesExtension struct {
	Dot11Configuration bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Dot11Configuration,omitempty"`
...
type SecurityCapabilities struct {
	...
	OnboardKeyGeneration bool `xml:"http://www.onvif.org/ver20/analytics/wsdl OnboardKeyGeneration,omitempty"`

	// Indicates whether or not access policy configuration is supported.
	AccessPolicyConfig bool `xml:"http://www.onvif.org/ver20/analytics/wsdl AccessPolicyConfig,omitempty"`
	...
	SAMLToken bool `xml:"http://www.onvif.org/ver20/analytics/wsdl SAMLToken,omitempty"`

	// Indicates whether or not WS-Security Kerberos token is supported.
	KerberosToken bool `xml:"http://www.onvif.org/ver20/analytics/wsdl KerberosToken,omitempty"`

	// Indicates whether or not WS-Security REL token is supported.
	RELToken bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RELToken,omitempty"`
...
type SecurityCapabilitiesExtension2 struct {
	Dot1X bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Dot1X,omitempty"`
	...
	RemoteUserHandling bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RemoteUserHandling,omitempty"`
}
...
type SystemCapabilities struct {
	...
	DiscoveryResolve bool `xml:"http://www.onvif.org/ver20/analytics/wsdl DiscoveryResolve,omitempty"`

	// Indicates whether or not WS-Discovery Bye is supported.
	DiscoveryBye bool `xml:"http://www.onvif.org/ver20/analytics/wsdl DiscoveryBye,omitempty"`

	// Indicates whether or not remote discovery is supported.
	RemoteDiscovery bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RemoteDiscovery,omitempty"`

	// Indicates whether or not system backup is supported.
	SystemBackup bool `xml:"http://www.onvif.org/ver20/analytics/wsdl SystemBackup,omitempty"`

	// Indicates whether or not system logging is supported.
	SystemLogging bool `xml:"http://www.onvif.org/ver20/analytics/wsdl SystemLogging,omitempty"`

	// Indicates whether or not firmware upgrade is supported.
	FirmwareUpgrade bool `xml:"http://www.onvif.org/ver20/analytics/wsdl FirmwareUpgrade,omitempty"`
...
type SystemCapabilitiesExtension struct {
	HttpFirmwareUpgrade bool `xml:"http://www.onvif.org/ver20/analytics/wsdl HttpFirmwareUpgrade,omitempty"`

	HttpSystemBackup bool `xml:"http://www.onvif.org/ver20/analytics/wsdl HttpSystemBackup,omitempty"`

	HttpSystemLogging bool `xml:"http://www.onvif.org/ver20/analytics/wsdl HttpSystemLogging,omitempty"`

	HttpSupportInformation bool `xml:"http://www.onvif.org/ver20/analytics/wsdl HttpSupportInformation,omitempty"`
...
type DisplayCapabilities struct {
	...
	FixedLayout bool `xml:"http://www.onvif.org/ver20/analytics/wsdl FixedLayout,omitempty"`
}
...
type RecordingCapabilities struct {
	...
	ReceiverSource bool `xml:"http://www.onvif.org/ver20/analytics/wsdl ReceiverSource,omitempty"`

	MediaProfileSource bool `xml:"http://www.onvif.org/ver20/analytics/wsdl MediaProfileSource,omitempty"`

	DynamicRecordings bool `xml:"http://www.onvif.org/ver20/analytics/wsdl DynamicRecordings,omitempty"`

	DynamicTracks bool `xml:"http://www.onvif.org/ver20/analytics/wsdl DynamicTracks,omitempty"`
...
type SearchCapabilities struct {
	...
	MetadataSearch bool `xml:"http://www.onvif.org/ver20/analytics/wsdl MetadataSearch,omitempty"`
}
...
type ReceiverCapabilities struct {
	...
	RTP_Multicast bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RTP_Multicast,omitempty"`
...
type SystemDateTime struct {
	...
	DaylightSavings bool `xml:"http://www.onvif.org/ver20/analytics/wsdl DaylightSavings,omitempty"`
...
type TimeZone struct {
	...
	TZ string `xml:"http://www.onvif.org/ver20/analytics/wsdl TZ,omitempty"`
}
...
type User struct {
	...
	// Username string.
	Username string `xml:"http://www.onvif.org/ver20/analytics/wsdl Username,omitempty"`

	// Password string.
	Password string `xml:"http://www.onvif.org/ver20/analytics/wsdl Password,omitempty"`
...
type CertificateGenerationParameters struct {
	CertificateID string `xml:"http://www.onvif.org/ver20/analytics/wsdl CertificateID,omitempty"`

	Subject string `xml:"http://www.onvif.org/ver20/analytics/wsdl Subject,omitempty"`

	ValidNotBefore string `xml:"http://www.onvif.org/ver20/analytics/wsdl ValidNotBefore,omitempty"`

	ValidNotAfter string `xml:"http://www.onvif.org/ver20/analytics/wsdl ValidNotAfter,omitempty"`
...
type CertificateInformation struct {
	...
	IssuerDN string `xml:"http://www.onvif.org/ver20/analytics/wsdl IssuerDN,omitempty"`

	SubjectDN string `xml:"http://www.onvif.org/ver20/analytics/wsdl SubjectDN,omitempty"`
	...
	Version string `xml:"http://www.onvif.org/ver20/analytics/wsdl Version,omitempty"`

	SerialNum string `xml:"http://www.onvif.org/ver20/analytics/wsdl SerialNum,omitempty"`

	// Validity Range is from "NotBefore" to "NotAfter"; the corresponding DateTimeRange is from "From" to "Until"
	SignatureAlgorithm string `xml:"http://www.onvif.org/ver20/analytics/wsdl SignatureAlgorithm,omitempty"`
...
type CertificateUsage struct {
	...
	Critical bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Critical,attr,omitempty"`
}
...
type Dot1XConfiguration struct {
	Dot1XConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl Dot1XConfigurationToken,omitempty"`

	Identity string `xml:"http://www.onvif.org/ver20/analytics/wsdl Identity,omitempty"`

	AnonymousID string `xml:"http://www.onvif.org/ver20/analytics/wsdl AnonymousID,omitempty"`
	...
	CACertificateID []string `xml:"http://www.onvif.org/ver20/analytics/wsdl CACertificateID,omitempty"`
...
type PTZNode struct {
	*DeviceEntity
	...
	//
	HomeSupported bool `xml:"http://www.onvif.org/ver20/analytics/wsdl HomeSupported,omitempty"`
	...
	FixedHomePosition bool `xml:"http://www.onvif.org/ver20/analytics/wsdl FixedHomePosition,attr,omitempty"`

	//
	// Indication whether the Node supports the geo-referenced move command.
	//

	GeoMove bool `xml:"http://www.onvif.org/ver20/analytics/wsdl GeoMove,attr,omitempty"`
}
...
type PTZConfiguration struct {
	*ConfigurationEntity
	...
	//
	NodeToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl NodeToken,omitempty"`
...
type PTZPresetTourPresetDetail struct {
	...
	PresetToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl PresetToken,omitempty"`
	...
	Home bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Home,omitempty"`
...
type PTZPresetTourStartingCondition struct {
	...
	RandomPresetOrder bool `xml:"http://www.onvif.org/ver20/analytics/wsdl RandomPresetOrder,attr,omitempty"`
}
...
type IrCutFilterAutoAdjustment struct {
	...
	BoundaryType string `xml:"http://www.onvif.org/ver20/analytics/wsdl BoundaryType,omitempty"`
...
type ToneCompensation struct {
	...
	Mode string `xml:"http://www.onvif.org/ver20/analytics/wsdl Mode,omitempty"`
...
type IrCutFilterAutoAdjustmentOptions struct {
	...
	BoundaryOffset bool `xml:"http://www.onvif.org/ver20/analytics/wsdl BoundaryOffset,omitempty"`
...
type ToneCompensationOptions struct {
	...
	Level bool `xml:"http://www.onvif.org/ver20/analytics/wsdl Level,omitempty"`
}
...
type MessageDescription struct {
	...
	IsProperty bool `xml:"http://www.onvif.org/ver20/analytics/wsdl IsProperty,attr,omitempty"`
}
...
type ConfigDescription struct {
	...
	Messages []struct {
		*MessageDescription
		...
		//
		ParentTopic string `xml:"http://www.onvif.org/ver20/analytics/wsdl ParentTopic,omitempty"`
	...
	Name QName `xml:"http://www.onvif.org/ver20/analytics/wsdl Name,attr,omitempty"`
...
type PaneLayout struct {
	...
	Pane ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl Pane,omitempty"`
...
type Receiver struct {
	...
	Token ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl Token,omitempty"`
...
type VideoAttributes struct {
	...
	Encoding string `xml:"http://www.onvif.org/ver20/analytics/wsdl Encoding,omitempty"`
...
type MetadataAttributes struct {
	...
	CanContainPTZ bool `xml:"http://www.onvif.org/ver20/analytics/wsdl CanContainPTZ,omitempty"`

	// Indicates that there can be analytics data in the metadata track in the specified time interval.
	CanContainAnalytics bool `xml:"http://www.onvif.org/ver20/analytics/wsdl CanContainAnalytics,omitempty"`

	// Indicates that there can be notifications in the metadata track in the specified time interval.
	CanContainNotifications bool `xml:"http://www.onvif.org/ver20/analytics/wsdl CanContainNotifications,omitempty"`
...
type RecordingJobConfiguration struct {
	...
	ScheduleToken string `xml:"http://www.onvif.org/ver20/analytics/wsdl ScheduleToken,attr,omitempty"`
}
...
type RecordingJobSource struct {
	...
	AutoCreateReceiver bool `xml:"http://www.onvif.org/ver20/analytics/wsdl AutoCreateReceiver,omitempty"`
...
type RecordingJobTrack struct {
	...
	SourceTag string `xml:"http://www.onvif.org/ver20/analytics/wsdl SourceTag,omitempty"`
...
type AnalyticsEngineInputInfo struct {
	InputInfo Config `xml:"http://www.onvif.org/ver20/analytics/wsdl InputInfo,omitempty"`
...
type MetadataInput struct {
	MetadataConfig []Config `xml:"http://www.onvif.org/ver20/analytics/wsdl MetadataConfig,omitempty"`
...
type OSDPosConfiguration struct {
	...
	//
	Type string `xml:"http://www.onvif.org/ver20/analytics/wsdl Type,omitempty"`
...
type OSDTextConfiguration struct {
	...
	//
	DateFormat string `xml:"http://www.onvif.org/ver20/analytics/wsdl DateFormat,omitempty"`
	...
	//
	TimeFormat string `xml:"http://www.onvif.org/ver20/analytics/wsdl TimeFormat,omitempty"`
	...
	PlainText string `xml:"http://www.onvif.org/ver20/analytics/wsdl PlainText,omitempty"`
	...
	IsPersistentText bool `xml:"http://www.onvif.org/ver20/analytics/wsdl IsPersistentText,attr,omitempty"`
}
...
type OSDConfigurationOptions struct {
	...
	//
	PositionOption []string `xml:"http://www.onvif.org/ver20/analytics/wsdl PositionOption,omitempty"`
...
type FileProgress struct {
	...
	// Exported file name
	FileName string `xml:"http://www.onvif.org/ver20/analytics/wsdl FileName,omitempty"`
...
type StorageReferencePath struct {
	...
	StorageToken ReferenceToken `xml:"http://www.onvif.org/ver20/analytics/wsdl StorageToken,omitempty"`

	// gives the relative directory path on the storage
	RelativePath string `xml:"http://www.onvif.org/ver20/analytics/wsdl RelativePath,omitempty"`
...
func NewRuleEnginePort(client *soap.Client, xaddr string) RuleEnginePort {
