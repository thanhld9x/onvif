...
const (
	// ConnectionStatusOffline const
	ConnectionStatusOffline ConnectionStatus = "Offline"

	// ConnectionStatusConnecting const
	ConnectionStatusConnecting ConnectionStatus = "Connecting"

	// ConnectionStatusConnected const
	ConnectionStatusConnected ConnectionStatus = "Connected"
)

// GetServiceCapabilities type
type GetServiceCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/uplink/wsdl GetServiceCapabilities"`
}
...
type GetUplinks struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/uplink/wsdl GetUplinks"`
}

// GetUplinksResponse type
...
type SetUplink struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/uplink/wsdl SetUplink"`

	// SConfiguration to be added or modified.
	Configuration Configuration `xml:"http://www.onvif.org/ver10/uplink/wsdl Configuration,omitempty"`
}

// SetUplinkResponse type
type SetUplinkResponse struct {
	XMLName xml.Name `xml:"SetUplinkResponse"`
}

// DeleteUplink type
type DeleteUplink struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/uplink/wsdl DeleteUplink"`

	// Uniform resource locator of the configuration to be deleted.
	RemoteAddress AnyURI `xml:"http://www.onvif.org/ver10/schema RemoteAddress,omitempty"`
}

// DeleteUplinkResponse type
type DeleteUplinkResponse struct {
	XMLName xml.Name `xml:"DeleteUplinkResponse"`
}
...
type Capabilities struct {
	...
	MaxUplinks int32 `xml:"http://www.onvif.org/ver10/schema MaxUplinks,attr,omitempty"`
}
...
type Configuration struct {
	...
	CertificateID string `xml:"http://www.onvif.org/ver10/uplink/wsdl CertificateID,omitempty"`

	// Authorization level that will be assigned to the uplink connection.
	UserLevel string `xml:"http://www.onvif.org/ver10/uplink/wsdl UserLevel,omitempty"`

	// Current connection status (see tup:ConnectionStatus for possible values).
	Status string `xml:"http://www.onvif.org/ver10/uplink/wsdl Status,omitempty"`
}
...
type PTZStatus struct {
	...
	//
	Error string `xml:"http://www.onvif.org/ver10/uplink/wsdl Error,omitempty"`
...
type VideoSourceConfiguration struct {
	*ConfigurationEntity
	...
	ViewMode string `xml:"http://www.onvif.org/ver10/uplink/wsdl ViewMode,attr,omitempty"`
}
...
type RotateOptions struct {
	...
	Reboot bool `xml:"http://www.onvif.org/ver10/schema Reboot,attr,omitempty"`
}
...
type SceneOrientation struct {
	...
	//
	Orientation string `xml:"http://www.onvif.org/ver10/uplink/wsdl Orientation,omitempty"`
}
...
type VideoEncoderConfiguration struct {
	*ConfigurationEntity
	...
	GuaranteedFrameRate bool `xml:"http://www.onvif.org/ver10/schema GuaranteedFrameRate,attr,omitempty"`
}
...
type MetadataConfiguration struct {
	*ConfigurationEntity
	...
	CompressionType string `xml:"http://www.onvif.org/ver10/uplink/wsdl CompressionType,attr,omitempty"`

	// Optional parameter to configure if the metadata stream shall contain the Geo Location coordinates of each target.

	GeoLocation bool `xml:"http://www.onvif.org/ver10/schema GeoLocation,attr,omitempty"`
}
...
type PTZFilter struct {
	...
	Status bool `xml:"http://www.onvif.org/ver10/schema Status,omitempty"`

	// True if the metadata stream shall contain the PTZ position
	Position bool `xml:"http://www.onvif.org/ver10/schema Position,omitempty"`
}
...
type MetadataConfigurationOptionsExtension struct {
	...
	CompressionType []string `xml:"http://www.onvif.org/ver10/uplink/wsdl CompressionType,omitempty"`
...
type PTZStatusFilterOptions struct {
	...
	PanTiltStatusSupported bool `xml:"http://www.onvif.org/ver10/schema PanTiltStatusSupported,omitempty"`

	// True if the device is able to stream zoom status inforamtion.
	ZoomStatusSupported bool `xml:"http://www.onvif.org/ver10/schema ZoomStatusSupported,omitempty"`

	// True if the device is able to stream the pan or tilt position.
	PanTiltPositionSupported bool `xml:"http://www.onvif.org/ver10/schema PanTiltPositionSupported,omitempty"`

	// True if the device is able to stream zoom position information.
	ZoomPositionSupported bool `xml:"http://www.onvif.org/ver10/schema ZoomPositionSupported,omitempty"`
...
type MulticastConfiguration struct {
	...
	AutoStart bool `xml:"http://www.onvif.org/ver10/schema AutoStart,omitempty"`
}
...
type NetworkInterface struct {
	*DeviceEntity
	...
	Enabled bool `xml:"http://www.onvif.org/ver10/schema Enabled,omitempty"`
...
type NetworkInterfaceConnectionSetting struct {
	...
	AutoNegotiation bool `xml:"http://www.onvif.org/ver10/schema AutoNegotiation,omitempty"`
...
type NetworkInterfaceInfo struct {
	...
	Name string `xml:"http://www.onvif.org/ver10/uplink/wsdl Name,omitempty"`
...
type IPv4Configuration struct {
	...
	DHCP bool `xml:"http://www.onvif.org/ver10/schema DHCP,omitempty"`
}
...
type IPv6Configuration struct {
	...
	AcceptRouterAdvert bool `xml:"http://www.onvif.org/ver10/schema AcceptRouterAdvert,omitempty"`
...
type HostnameInformation struct {
	...
	FromDHCP bool `xml:"http://www.onvif.org/ver10/schema FromDHCP,omitempty"`
...
type DNSInformation struct {
	...
	// Search domain.
	SearchDomain []string `xml:"http://www.onvif.org/ver10/uplink/wsdl SearchDomain,omitempty"`
...
type Dot11AvailableNetworks struct {
	...
	BSSID string `xml:"http://www.onvif.org/ver10/uplink/wsdl BSSID,omitempty"`
...
type AnalyticsCapabilities struct {
	...
	RuleSupport bool `xml:"http://www.onvif.org/ver10/schema RuleSupport,omitempty"`

	// Indicates whether or not modules are supported.
	AnalyticsModuleSupport bool `xml:"http://www.onvif.org/ver10/schema AnalyticsModuleSupport,omitempty"`
}
...
type EventCapabilities struct {
	...
	WSSubscriptionPolicySupport bool `xml:"http://www.onvif.org/ver10/schema WSSubscriptionPolicySupport,omitempty"`

	// Indicates whether or not WS Pull Point is supported.
	WSPullPointSupport bool `xml:"http://www.onvif.org/ver10/schema WSPullPointSupport,omitempty"`

	// Indicates whether or not WS Pausable Subscription Manager Interface is supported.
	WSPausableSubscriptionManagerInterfaceSupport bool `xml:"http://www.onvif.org/ver10/schema WSPausableSubscriptionManagerInterfaceSupport,omitempty"`
}
...
type IOCapabilitiesExtension struct {
	Auxiliary bool `xml:"http://www.onvif.org/ver10/schema Auxiliary,omitempty"`
...
type RealTimeStreamingCapabilities struct {
	...
	RTPMulticast bool `xml:"http://www.onvif.org/ver10/schema RTPMulticast,omitempty"`

	// Indicates whether or not RTP over TCP is supported.
	RTP_TCP bool `xml:"http://www.onvif.org/ver10/schema RTP_TCP,omitempty"`

	// Indicates whether or not RTP/RTSP/TCP is supported.
	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver10/schema RTP_RTSP_TCP,omitempty"`
...
type NetworkCapabilities struct {
	...
	IPFilter bool `xml:"http://www.onvif.org/ver10/schema IPFilter,omitempty"`

	// Indicates whether or not zeroconf is supported.
	ZeroConfiguration bool `xml:"http://www.onvif.org/ver10/schema ZeroConfiguration,omitempty"`

	// Indicates whether or not IPv6 is supported.
	IPVersion6 bool `xml:"http://www.onvif.org/ver10/schema IPVersion6,omitempty"`

	// Indicates whether or not  is supported.
	DynDNS bool `xml:"http://www.onvif.org/ver10/schema DynDNS,omitempty"`
...
type NetworkCapabilitiesExtension struct {
	Dot11Configuration bool `xml:"http://www.onvif.org/ver10/schema Dot11Configuration,omitempty"`
...
type SecurityCapabilities struct {
	...
	OnboardKeyGeneration bool `xml:"http://www.onvif.org/ver10/schema OnboardKeyGeneration,omitempty"`

	// Indicates whether or not access policy configuration is supported.
	AccessPolicyConfig bool `xml:"http://www.onvif.org/ver10/schema AccessPolicyConfig,omitempty"`
	...
	SAMLToken bool `xml:"http://www.onvif.org/ver10/schema SAMLToken,omitempty"`

	// Indicates whether or not WS-Security Kerberos token is supported.
	KerberosToken bool `xml:"http://www.onvif.org/ver10/schema KerberosToken,omitempty"`

	// Indicates whether or not WS-Security REL token is supported.
	RELToken bool `xml:"http://www.onvif.org/ver10/schema RELToken,omitempty"`
...
type SecurityCapabilitiesExtension2 struct {
	Dot1X bool `xml:"http://www.onvif.org/ver10/schema Dot1X,omitempty"`
	...
	RemoteUserHandling bool `xml:"http://www.onvif.org/ver10/schema RemoteUserHandling,omitempty"`
}
...
type SystemCapabilities struct {
	...
	DiscoveryResolve bool `xml:"http://www.onvif.org/ver10/schema DiscoveryResolve,omitempty"`

	// Indicates whether or not WS-Discovery Bye is supported.
	DiscoveryBye bool `xml:"http://www.onvif.org/ver10/schema DiscoveryBye,omitempty"`

	// Indicates whether or not remote discovery is supported.
	RemoteDiscovery bool `xml:"http://www.onvif.org/ver10/schema RemoteDiscovery,omitempty"`

	// Indicates whether or not system backup is supported.
	SystemBackup bool `xml:"http://www.onvif.org/ver10/schema SystemBackup,omitempty"`

	// Indicates whether or not system logging is supported.
	SystemLogging bool `xml:"http://www.onvif.org/ver10/schema SystemLogging,omitempty"`

	// Indicates whether or not firmware upgrade is supported.
	FirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/schema FirmwareUpgrade,omitempty"`
...
type SystemCapabilitiesExtension struct {
	HttpFirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/schema HttpFirmwareUpgrade,omitempty"`

	HttpSystemBackup bool `xml:"http://www.onvif.org/ver10/schema HttpSystemBackup,omitempty"`

	HttpSystemLogging bool `xml:"http://www.onvif.org/ver10/schema HttpSystemLogging,omitempty"`

	HttpSupportInformation bool `xml:"http://www.onvif.org/ver10/schema HttpSupportInformation,omitempty"`
...
type DisplayCapabilities struct {
	...
	FixedLayout bool `xml:"http://www.onvif.org/ver10/schema FixedLayout,omitempty"`
}
...
type RecordingCapabilities struct {
	...
	ReceiverSource bool `xml:"http://www.onvif.org/ver10/schema ReceiverSource,omitempty"`

	MediaProfileSource bool `xml:"http://www.onvif.org/ver10/schema MediaProfileSource,omitempty"`

	DynamicRecordings bool `xml:"http://www.onvif.org/ver10/schema DynamicRecordings,omitempty"`

	DynamicTracks bool `xml:"http://www.onvif.org/ver10/schema DynamicTracks,omitempty"`
...
type SearchCapabilities struct {
	...
	MetadataSearch bool `xml:"http://www.onvif.org/ver10/schema MetadataSearch,omitempty"`
}
...
type ReceiverCapabilities struct {
	...
	RTP_Multicast bool `xml:"http://www.onvif.org/ver10/schema RTP_Multicast,omitempty"`
...
type SystemDateTime struct {
	...
	DaylightSavings bool `xml:"http://www.onvif.org/ver10/schema DaylightSavings,omitempty"`
...
type TimeZone struct {
	...
	TZ string `xml:"http://www.onvif.org/ver10/uplink/wsdl TZ,omitempty"`
}
...
type User struct {
	...
	// Username string.
	Username string `xml:"http://www.onvif.org/ver10/uplink/wsdl Username,omitempty"`

	// Password string.
	Password string `xml:"http://www.onvif.org/ver10/uplink/wsdl Password,omitempty"`
...
type CertificateGenerationParameters struct {
	...
	Subject string `xml:"http://www.onvif.org/ver10/uplink/wsdl Subject,omitempty"`

	ValidNotBefore string `xml:"http://www.onvif.org/ver10/uplink/wsdl ValidNotBefore,omitempty"`

	ValidNotAfter string `xml:"http://www.onvif.org/ver10/uplink/wsdl ValidNotAfter,omitempty"`
...
type CertificateInformation struct {
	...
	IssuerDN string `xml:"http://www.onvif.org/ver10/uplink/wsdl IssuerDN,omitempty"`

	SubjectDN string `xml:"http://www.onvif.org/ver10/uplink/wsdl SubjectDN,omitempty"`
	...
	Version string `xml:"http://www.onvif.org/ver10/uplink/wsdl Version,omitempty"`

	SerialNum string `xml:"http://www.onvif.org/ver10/uplink/wsdl SerialNum,omitempty"`

	// Validity Range is from "NotBefore" to "NotAfter"; the corresponding DateTimeRange is from "From" to "Until"
	SignatureAlgorithm string `xml:"http://www.onvif.org/ver10/uplink/wsdl SignatureAlgorithm,omitempty"`
...
type CertificateUsage struct {
	...
	Critical bool `xml:"http://www.onvif.org/ver10/schema Critical,attr,omitempty"`
}
...
type Dot1XConfiguration struct {
	...
	Identity string `xml:"http://www.onvif.org/ver10/uplink/wsdl Identity,omitempty"`

	AnonymousID string `xml:"http://www.onvif.org/ver10/uplink/wsdl AnonymousID,omitempty"`
	...
	CACertificateID []string `xml:"http://www.onvif.org/ver10/uplink/wsdl CACertificateID,omitempty"`
...
type PTZNode struct {
	*DeviceEntity
	...
	//
	HomeSupported bool `xml:"http://www.onvif.org/ver10/schema HomeSupported,omitempty"`
	...
	FixedHomePosition bool `xml:"http://www.onvif.org/ver10/schema FixedHomePosition,attr,omitempty"`

	//
	// Indication whether the Node supports the geo-referenced move command.
	//

	GeoMove bool `xml:"http://www.onvif.org/ver10/schema GeoMove,attr,omitempty"`
}
...
type PTZPresetTourPresetDetail struct {
	...
	Home bool `xml:"http://www.onvif.org/ver10/schema Home,omitempty"`
...
type PTZPresetTourStartingCondition struct {
	...
	RandomPresetOrder bool `xml:"http://www.onvif.org/ver10/schema RandomPresetOrder,attr,omitempty"`
}
...
type IrCutFilterAutoAdjustment struct {
	...
	BoundaryType string `xml:"http://www.onvif.org/ver10/uplink/wsdl BoundaryType,omitempty"`
...
type ToneCompensation struct {
	...
	Mode string `xml:"http://www.onvif.org/ver10/uplink/wsdl Mode,omitempty"`
...
type IrCutFilterAutoAdjustmentOptions struct {
	...
	BoundaryOffset bool `xml:"http://www.onvif.org/ver10/schema BoundaryOffset,omitempty"`
...
type ToneCompensationOptions struct {
	...
	Level bool `xml:"http://www.onvif.org/ver10/schema Level,omitempty"`
}
...
type ItemList struct {
	SimpleItem []struct {
		...
		Name string `xml:"http://www.onvif.org/ver10/uplink/wsdl Name,attr,omitempty"`
...
type MessageDescription struct {
	...
	IsProperty bool `xml:"http://www.onvif.org/ver10/schema IsProperty,attr,omitempty"`
}
...
type AnalyticsEngineConfiguration struct {
	AnalyticsModule []Config `xml:"http://www.onvif.org/ver10/uplink/wsdl AnalyticsModule,omitempty"`
...
type RuleEngineConfiguration struct {
	Rule []Config `xml:"http://www.onvif.org/ver10/uplink/wsdl Rule,omitempty"`
...
type ConfigDescription struct {
	...
	Messages []struct {
		*MessageDescription
		...
		//
		ParentTopic string `xml:"http://www.onvif.org/ver10/uplink/wsdl ParentTopic,omitempty"`
...
type VideoAttributes struct {
	...
	Encoding string `xml:"http://www.onvif.org/ver10/uplink/wsdl Encoding,omitempty"`
...
type MetadataAttributes struct {
	...
	CanContainPTZ bool `xml:"http://www.onvif.org/ver10/schema CanContainPTZ,omitempty"`

	// Indicates that there can be analytics data in the metadata track in the specified time interval.
	CanContainAnalytics bool `xml:"http://www.onvif.org/ver10/schema CanContainAnalytics,omitempty"`

	// Indicates that there can be notifications in the metadata track in the specified time interval.
	CanContainNotifications bool `xml:"http://www.onvif.org/ver10/schema CanContainNotifications,omitempty"`
...
type RecordingJobConfiguration struct {
	...
	ScheduleToken string `xml:"http://www.onvif.org/ver10/uplink/wsdl ScheduleToken,attr,omitempty"`
}
...
type RecordingJobSource struct {
	...
	AutoCreateReceiver bool `xml:"http://www.onvif.org/ver10/schema AutoCreateReceiver,omitempty"`
...
type RecordingJobTrack struct {
	...
	SourceTag string `xml:"http://www.onvif.org/ver10/uplink/wsdl SourceTag,omitempty"`
...
type AnalyticsEngineInputInfo struct {
	InputInfo Config `xml:"http://www.onvif.org/ver10/uplink/wsdl InputInfo,omitempty"`
...
type MetadataInput struct {
	MetadataConfig []Config `xml:"http://www.onvif.org/ver10/uplink/wsdl MetadataConfig,omitempty"`
...
type OSDPosConfiguration struct {
	...
	//
	Type string `xml:"http://www.onvif.org/ver10/uplink/wsdl Type,omitempty"`
...
type OSDTextConfiguration struct {
	...
	//
	DateFormat string `xml:"http://www.onvif.org/ver10/uplink/wsdl DateFormat,omitempty"`
	...
	//
	TimeFormat string `xml:"http://www.onvif.org/ver10/uplink/wsdl TimeFormat,omitempty"`
	...
	PlainText string `xml:"http://www.onvif.org/ver10/uplink/wsdl PlainText,omitempty"`
	...
	IsPersistentText bool `xml:"http://www.onvif.org/ver10/schema IsPersistentText,attr,omitempty"`
}
...
type OSDConfigurationOptions struct {
	...
	//
	PositionOption []string `xml:"http://www.onvif.org/ver10/uplink/wsdl PositionOption,omitempty"`
...
type FileProgress struct {
	...
	// Exported file name
	FileName string `xml:"http://www.onvif.org/ver10/uplink/wsdl FileName,omitempty"`
...
type StorageReferencePath struct {
	...
	RelativePath string `xml:"http://www.onvif.org/ver10/uplink/wsdl RelativePath,omitempty"`
...
type UplinkPort interface {
	...
	*/
	GetUplinks(request *GetUplinks) (*GetUplinksResponse, error)

	GetUplinksContext(ctx context.Context, request *GetUplinks) (*GetUplinksResponse, error)
	...
	*/
	SetUplink(request *SetUplink) (*SetUplinkResponse, error)

	SetUplinkContext(ctx context.Context, request *SetUplink) (*SetUplinkResponse, error)

	/*
		A device supporting uplinks shall support this command to remove an uplink configuration.
	*/
	DeleteUplink(request *DeleteUplink) (*DeleteUplinkResponse, error)

	DeleteUplinkContext(ctx context.Context, request *DeleteUplink) (*DeleteUplinkResponse, error)
}
...
func NewUplinkPort(client *soap.Client, xaddr string) UplinkPort {
	return &uplinkPort{
		client: client,
		xaddr:  xaddr,
	}
...
func (service *uplinkPort) GetServiceCapabilitiesContext(ctx context.Context, request *GetServiceCapabilities) (*GetServiceCapabilitiesResponse, error) {
	response := new(GetServiceCapabilitiesResponse)
	err := service.client.CallContext(ctx, service.xaddr, "http://www.onvif.org/ver10/uplink/wsdl/GetServiceCapabilities", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *uplinkPort) GetServiceCapabilities(request *GetServiceCapabilities) (*GetServiceCapabilitiesResponse, error) {
...
func (service *uplinkPort) GetUplinksContext(ctx context.Context, request *GetUplinks) (*GetUplinksResponse, error) {
	response := new(GetUplinksResponse)
	err := service.client.CallContext(ctx, service.xaddr, "http://www.onvif.org/ver10/uplink/wsdl/GetUplinks", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *uplinkPort) GetUplinks(request *GetUplinks) (*GetUplinksResponse, error) {
	return service.GetUplinksContext(
		context.Background(),
		request,
	)
}

func (service *uplinkPort) SetUplinkContext(ctx context.Context, request *SetUplink) (*SetUplinkResponse, error) {
	response := new(SetUplinkResponse)
	err := service.client.CallContext(ctx, service.xaddr, "http://www.onvif.org/ver10/uplink/wsdl/SetUplink", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *uplinkPort) SetUplink(request *SetUplink) (*SetUplinkResponse, error) {
	return service.SetUplinkContext(
		context.Background(),
		request,
	)
}

func (service *uplinkPort) DeleteUplinkContext(ctx context.Context, request *DeleteUplink) (*DeleteUplinkResponse, error) {
	response := new(DeleteUplinkResponse)
	err := service.client.CallContext(ctx, service.xaddr, "http://www.onvif.org/ver10/uplink/wsdl/DeleteUplink", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *uplinkPort) DeleteUplink(request *DeleteUplink) (*DeleteUplinkResponse, error) {
	return service.DeleteUplinkContext(
		context.Background(),
		request,
	)
}
