...
type GetServiceCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetServiceCapabilities"`
}
...
type CreateRecording struct {
	...
	RecordingConfiguration RecordingConfiguration `xml:"http://www.onvif.org/ver10/recording/wsdl RecordingConfiguration,omitempty"`
}
...
type DeleteRecording struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl DeleteRecording"`
...
type GetRecordings struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordings"`
}
...
type GetRecordingsResponse struct {
	...
	RecordingItem []GetRecordingsResponseItem `xml:"RecordingItem,omitempty"`
}

// SetRecordingConfiguration type
type SetRecordingConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl SetRecordingConfiguration"`
...
type GetRecordingConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingConfiguration"`
...
type CreateTrack struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl CreateTrack"`

	// Identifies the recording to which a track shall be added.
	RecordingToken RecordingReference `xml:"http://www.onvif.org/ver10/recording/wsdl RecordingToken,omitempty"`

	// The configuration of the new track.
	TrackConfiguration TrackConfiguration `xml:"http://www.onvif.org/ver10/recording/wsdl TrackConfiguration,omitempty"`
}
...
type DeleteTrack struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl DeleteTrack"`

	// Token of the recording the track belongs to.
	RecordingToken RecordingReference `xml:"http://www.onvif.org/ver10/recording/wsdl RecordingToken,omitempty"`

	// Token of the track to be deleted.
	TrackToken TrackReference `xml:"http://www.onvif.org/ver10/recording/wsdl TrackToken,omitempty"`
}
...
type GetTrackConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetTrackConfiguration"`
...
type SetTrackConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl SetTrackConfiguration"`
...
type CreateRecordingJob struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl CreateRecordingJob"`

	// The initial configuration of the new recording job.
	JobConfiguration RecordingJobConfiguration `xml:"http://www.onvif.org/ver10/recording/wsdl JobConfiguration,omitempty"`
}
...
type DeleteRecordingJob struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl DeleteRecordingJob"`

	// The token of the job to be deleted.
	JobToken RecordingJobReference `xml:"http://www.onvif.org/ver10/recording/wsdl JobToken,omitempty"`
}
...
type GetRecordingJobs struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingJobs"`
}
...
type SetRecordingJobConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl SetRecordingJobConfiguration"`
...
type GetRecordingJobConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingJobConfiguration"`
...
type SetRecordingJobMode struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl SetRecordingJobMode"`
...
type GetRecordingJobState struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingJobState"`
...
type GetRecordingOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingOptions"`
...
type ExportRecordedData struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl ExportRecordedData"`
	...
	SearchScope SearchScope `xml:"http://www.onvif.org/ver10/recording/wsdl SearchScope,omitempty"`

	// Indicates which export file format to be used.
	FileFormat string `xml:"http://www.onvif.org/ver10/recording/wsdl FileFormat,omitempty"`

	// Indicates the target storage and relative directory path.
	StorageDestination StorageReferencePath `xml:"http://www.onvif.org/ver10/recording/wsdl StorageDestination,omitempty"`
}
...
type StopExportRecordedData struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl StopExportRecordedData"`

	// Unique ExportRecordedData operation token
	OperationToken ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl OperationToken,omitempty"`
}
...
type GetExportRecordedDataState struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetExportRecordedDataState"`
...
type Capabilities struct {
	...
	DynamicRecordings bool `xml:"http://www.onvif.org/ver10/recording/wsdl DynamicRecordings,attr,omitempty"`

	// Indication if the device supports dynamic creation and deletion of tracks

	DynamicTracks bool `xml:"http://www.onvif.org/ver10/recording/wsdl DynamicTracks,attr,omitempty"`
	...
	Encoding EncodingTypes `xml:"http://www.onvif.org/ver10/recording/wsdl Encoding,attr,omitempty"`

	// Maximum supported bit rate for all tracks of a recording in kBit/s.

	MaxRate float32 `xml:"http://www.onvif.org/ver10/schema MaxRate,attr,omitempty"`

	// Maximum supported bit rate for all recordings in kBit/s.

	MaxTotalRate float32 `xml:"http://www.onvif.org/ver10/schema MaxTotalRate,attr,omitempty"`

	// Maximum number of recordings supported. (Integer values only.)

	MaxRecordings float32 `xml:"http://www.onvif.org/ver10/schema MaxRecordings,attr,omitempty"`

	// Maximum total number of supported recording jobs by the device.

	MaxRecordingJobs int32 `xml:"http://www.onvif.org/ver10/schema MaxRecordingJobs,attr,omitempty"`

	// Indication if the device supports the GetRecordingOptions command.

	Options bool `xml:"http://www.onvif.org/ver10/recording/wsdl Options,attr,omitempty"`

	// Indication if the device supports recording metadata.

	MetadataRecording bool `xml:"http://www.onvif.org/ver10/recording/wsdl MetadataRecording,attr,omitempty"`
	...
	SupportedExportFileFormats StringAttrList `xml:"http://www.onvif.org/ver10/recording/wsdl SupportedExportFileFormats,attr,omitempty"`
}

// RecordingOptions type
type RecordingOptions struct {
	Job JobOptions `xml:"http://www.onvif.org/ver10/recording/wsdl Job,omitempty"`

	Track TrackOptions `xml:"http://www.onvif.org/ver10/recording/wsdl Track,omitempty"`
}
...
type JobOptions struct {
	...
	Spare int32 `xml:"http://www.onvif.org/ver10/schema Spare,attr,omitempty"`
	...
	CompatibleSources StringAttrList `xml:"http://www.onvif.org/ver10/recording/wsdl CompatibleSources,attr,omitempty"`
}
...
type TrackOptions struct {
	...
	SpareTotal int32 `xml:"http://www.onvif.org/ver10/schema SpareTotal,attr,omitempty"`

	// Number of spare Video tracks that can be added to this recording.

	SpareVideo int32 `xml:"http://www.onvif.org/ver10/schema SpareVideo,attr,omitempty"`

	// Number of spare Aduio tracks that can be added to this recording.

	SpareAudio int32 `xml:"http://www.onvif.org/ver10/schema SpareAudio,attr,omitempty"`

	// Number of spare Metadata tracks that can be added to this recording.

	SpareMetadata int32 `xml:"http://www.onvif.org/ver10/schema SpareMetadata,attr,omitempty"`
}
...
type PTZStatus struct {
	...
	//
	Error string `xml:"http://www.onvif.org/ver10/recording/wsdl Error,omitempty"`
...
type VideoSourceConfiguration struct {
	*ConfigurationEntity
	...
	SourceToken ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl SourceToken,omitempty"`
	...
	ViewMode string `xml:"http://www.onvif.org/ver10/recording/wsdl ViewMode,attr,omitempty"`
}
...
type VideoSourceConfigurationOptions struct {
	...
	VideoSourceTokensAvailable []ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl VideoSourceTokensAvailable,omitempty"`
...
type RotateOptions struct {
	...
	Reboot bool `xml:"http://www.onvif.org/ver10/recording/wsdl Reboot,attr,omitempty"`
}
...
type SceneOrientation struct {
	...
	//
	Orientation string `xml:"http://www.onvif.org/ver10/recording/wsdl Orientation,omitempty"`
}
...
type VideoEncoderConfiguration struct {
	*ConfigurationEntity
	...
	GuaranteedFrameRate bool `xml:"http://www.onvif.org/ver10/recording/wsdl GuaranteedFrameRate,attr,omitempty"`
}
...
type MetadataConfiguration struct {
	*ConfigurationEntity
	...
	Analytics bool `xml:"http://www.onvif.org/ver10/recording/wsdl Analytics,omitempty"`
	...
	CompressionType string `xml:"http://www.onvif.org/ver10/recording/wsdl CompressionType,attr,omitempty"`

	// Optional parameter to configure if the metadata stream shall contain the Geo Location coordinates of each target.

	GeoLocation bool `xml:"http://www.onvif.org/ver10/recording/wsdl GeoLocation,attr,omitempty"`
}
...
type PTZFilter struct {
	...
	Status bool `xml:"http://www.onvif.org/ver10/recording/wsdl Status,omitempty"`

	// True if the metadata stream shall contain the PTZ position
	Position bool `xml:"http://www.onvif.org/ver10/recording/wsdl Position,omitempty"`
}
...
type MetadataConfigurationOptionsExtension struct {
	...
	CompressionType []string `xml:"http://www.onvif.org/ver10/recording/wsdl CompressionType,omitempty"`
...
type PTZStatusFilterOptions struct {
	...
	PanTiltStatusSupported bool `xml:"http://www.onvif.org/ver10/recording/wsdl PanTiltStatusSupported,omitempty"`

	// True if the device is able to stream zoom status inforamtion.
	ZoomStatusSupported bool `xml:"http://www.onvif.org/ver10/recording/wsdl ZoomStatusSupported,omitempty"`

	// True if the device is able to stream the pan or tilt position.
	PanTiltPositionSupported bool `xml:"http://www.onvif.org/ver10/recording/wsdl PanTiltPositionSupported,omitempty"`

	// True if the device is able to stream zoom position information.
	ZoomPositionSupported bool `xml:"http://www.onvif.org/ver10/recording/wsdl ZoomPositionSupported,omitempty"`
...
type AudioOutputConfiguration struct {
	*ConfigurationEntity
	...
	OutputToken ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl OutputToken,omitempty"`
...
type MulticastConfiguration struct {
	...
	AutoStart bool `xml:"http://www.onvif.org/ver10/recording/wsdl AutoStart,omitempty"`
}
...
type NetworkInterface struct {
	*DeviceEntity
	...
	Enabled bool `xml:"http://www.onvif.org/ver10/recording/wsdl Enabled,omitempty"`
...
type NetworkInterfaceConnectionSetting struct {
	...
	AutoNegotiation bool `xml:"http://www.onvif.org/ver10/recording/wsdl AutoNegotiation,omitempty"`
...
type NetworkInterfaceInfo struct {
	...
	Name string `xml:"http://www.onvif.org/ver10/recording/wsdl Name,omitempty"`
...
type IPv4Configuration struct {
	...
	DHCP bool `xml:"http://www.onvif.org/ver10/recording/wsdl DHCP,omitempty"`
}
...
type IPv6Configuration struct {
	...
	AcceptRouterAdvert bool `xml:"http://www.onvif.org/ver10/recording/wsdl AcceptRouterAdvert,omitempty"`
...
type HostnameInformation struct {
	...
	FromDHCP bool `xml:"http://www.onvif.org/ver10/recording/wsdl FromDHCP,omitempty"`
...
type DNSInformation struct {
	...
	// Search domain.
	SearchDomain []string `xml:"http://www.onvif.org/ver10/recording/wsdl SearchDomain,omitempty"`
...
type NetworkZeroConfiguration struct {
	...
	InterfaceToken ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl InterfaceToken,omitempty"`
...
type Dot11SecurityConfiguration struct {
	...
	Dot1X ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl Dot1X,omitempty"`
...
type Dot11AvailableNetworks struct {
	...
	BSSID string `xml:"http://www.onvif.org/ver10/recording/wsdl BSSID,omitempty"`
...
type AnalyticsCapabilities struct {
	...
	RuleSupport bool `xml:"http://www.onvif.org/ver10/recording/wsdl RuleSupport,omitempty"`

	// Indicates whether or not modules are supported.
	AnalyticsModuleSupport bool `xml:"http://www.onvif.org/ver10/recording/wsdl AnalyticsModuleSupport,omitempty"`
}
...
type EventCapabilities struct {
	...
	WSSubscriptionPolicySupport bool `xml:"http://www.onvif.org/ver10/recording/wsdl WSSubscriptionPolicySupport,omitempty"`

	// Indicates whether or not WS Pull Point is supported.
	WSPullPointSupport bool `xml:"http://www.onvif.org/ver10/recording/wsdl WSPullPointSupport,omitempty"`

	// Indicates whether or not WS Pausable Subscription Manager Interface is supported.
	WSPausableSubscriptionManagerInterfaceSupport bool `xml:"http://www.onvif.org/ver10/recording/wsdl WSPausableSubscriptionManagerInterfaceSupport,omitempty"`
}
...
type IOCapabilitiesExtension struct {
	Auxiliary bool `xml:"http://www.onvif.org/ver10/recording/wsdl Auxiliary,omitempty"`
...
type RealTimeStreamingCapabilities struct {
	...
	RTPMulticast bool `xml:"http://www.onvif.org/ver10/recording/wsdl RTPMulticast,omitempty"`

	// Indicates whether or not RTP over TCP is supported.
	RTP_TCP bool `xml:"http://www.onvif.org/ver10/recording/wsdl RTP_TCP,omitempty"`

	// Indicates whether or not RTP/RTSP/TCP is supported.
	RTP_RTSP_TCP bool `xml:"http://www.onvif.org/ver10/recording/wsdl RTP_RTSP_TCP,omitempty"`
...
type NetworkCapabilities struct {
	...
	IPFilter bool `xml:"http://www.onvif.org/ver10/recording/wsdl IPFilter,omitempty"`

	// Indicates whether or not zeroconf is supported.
	ZeroConfiguration bool `xml:"http://www.onvif.org/ver10/recording/wsdl ZeroConfiguration,omitempty"`

	// Indicates whether or not IPv6 is supported.
	IPVersion6 bool `xml:"http://www.onvif.org/ver10/recording/wsdl IPVersion6,omitempty"`

	// Indicates whether or not  is supported.
	DynDNS bool `xml:"http://www.onvif.org/ver10/recording/wsdl DynDNS,omitempty"`
...
type NetworkCapabilitiesExtension struct {
	Dot11Configuration bool `xml:"http://www.onvif.org/ver10/recording/wsdl Dot11Configuration,omitempty"`
...
type SecurityCapabilities struct {
	...
	OnboardKeyGeneration bool `xml:"http://www.onvif.org/ver10/recording/wsdl OnboardKeyGeneration,omitempty"`

	// Indicates whether or not access policy configuration is supported.
	AccessPolicyConfig bool `xml:"http://www.onvif.org/ver10/recording/wsdl AccessPolicyConfig,omitempty"`
	...
	SAMLToken bool `xml:"http://www.onvif.org/ver10/recording/wsdl SAMLToken,omitempty"`

	// Indicates whether or not WS-Security Kerberos token is supported.
	KerberosToken bool `xml:"http://www.onvif.org/ver10/recording/wsdl KerberosToken,omitempty"`

	// Indicates whether or not WS-Security REL token is supported.
	RELToken bool `xml:"http://www.onvif.org/ver10/recording/wsdl RELToken,omitempty"`
...
type SecurityCapabilitiesExtension2 struct {
	Dot1X bool `xml:"http://www.onvif.org/ver10/recording/wsdl Dot1X,omitempty"`
	...
	RemoteUserHandling bool `xml:"http://www.onvif.org/ver10/recording/wsdl RemoteUserHandling,omitempty"`
}
...
type SystemCapabilities struct {
	...
	DiscoveryResolve bool `xml:"http://www.onvif.org/ver10/recording/wsdl DiscoveryResolve,omitempty"`

	// Indicates whether or not WS-Discovery Bye is supported.
	DiscoveryBye bool `xml:"http://www.onvif.org/ver10/recording/wsdl DiscoveryBye,omitempty"`

	// Indicates whether or not remote discovery is supported.
	RemoteDiscovery bool `xml:"http://www.onvif.org/ver10/recording/wsdl RemoteDiscovery,omitempty"`

	// Indicates whether or not system backup is supported.
	SystemBackup bool `xml:"http://www.onvif.org/ver10/recording/wsdl SystemBackup,omitempty"`

	// Indicates whether or not system logging is supported.
	SystemLogging bool `xml:"http://www.onvif.org/ver10/recording/wsdl SystemLogging,omitempty"`

	// Indicates whether or not firmware upgrade is supported.
	FirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/recording/wsdl FirmwareUpgrade,omitempty"`
...
type SystemCapabilitiesExtension struct {
	HttpFirmwareUpgrade bool `xml:"http://www.onvif.org/ver10/recording/wsdl HttpFirmwareUpgrade,omitempty"`

	HttpSystemBackup bool `xml:"http://www.onvif.org/ver10/recording/wsdl HttpSystemBackup,omitempty"`

	HttpSystemLogging bool `xml:"http://www.onvif.org/ver10/recording/wsdl HttpSystemLogging,omitempty"`

	HttpSupportInformation bool `xml:"http://www.onvif.org/ver10/recording/wsdl HttpSupportInformation,omitempty"`
...
type DisplayCapabilities struct {
	...
	FixedLayout bool `xml:"http://www.onvif.org/ver10/recording/wsdl FixedLayout,omitempty"`
}
...
type RecordingCapabilities struct {
	...
	ReceiverSource bool `xml:"http://www.onvif.org/ver10/recording/wsdl ReceiverSource,omitempty"`

	MediaProfileSource bool `xml:"http://www.onvif.org/ver10/recording/wsdl MediaProfileSource,omitempty"`

	DynamicRecordings bool `xml:"http://www.onvif.org/ver10/recording/wsdl DynamicRecordings,omitempty"`

	DynamicTracks bool `xml:"http://www.onvif.org/ver10/recording/wsdl DynamicTracks,omitempty"`
...
type SearchCapabilities struct {
	...
	MetadataSearch bool `xml:"http://www.onvif.org/ver10/recording/wsdl MetadataSearch,omitempty"`
}
...
type ReceiverCapabilities struct {
	...
	RTP_Multicast bool `xml:"http://www.onvif.org/ver10/recording/wsdl RTP_Multicast,omitempty"`
...
type SystemDateTime struct {
	...
	DaylightSavings bool `xml:"http://www.onvif.org/ver10/recording/wsdl DaylightSavings,omitempty"`
...
type TimeZone struct {
	...
	TZ string `xml:"http://www.onvif.org/ver10/recording/wsdl TZ,omitempty"`
}
...
type User struct {
	...
	// Username string.
	Username string `xml:"http://www.onvif.org/ver10/recording/wsdl Username,omitempty"`

	// Password string.
	Password string `xml:"http://www.onvif.org/ver10/recording/wsdl Password,omitempty"`
...
type CertificateGenerationParameters struct {
	CertificateID string `xml:"http://www.onvif.org/ver10/recording/wsdl CertificateID,omitempty"`

	Subject string `xml:"http://www.onvif.org/ver10/recording/wsdl Subject,omitempty"`

	ValidNotBefore string `xml:"http://www.onvif.org/ver10/recording/wsdl ValidNotBefore,omitempty"`

	ValidNotAfter string `xml:"http://www.onvif.org/ver10/recording/wsdl ValidNotAfter,omitempty"`
...
type CertificateInformation struct {
	...
	IssuerDN string `xml:"http://www.onvif.org/ver10/recording/wsdl IssuerDN,omitempty"`

	SubjectDN string `xml:"http://www.onvif.org/ver10/recording/wsdl SubjectDN,omitempty"`
	...
	Version string `xml:"http://www.onvif.org/ver10/recording/wsdl Version,omitempty"`

	SerialNum string `xml:"http://www.onvif.org/ver10/recording/wsdl SerialNum,omitempty"`

	// Validity Range is from "NotBefore" to "NotAfter"; the corresponding DateTimeRange is from "From" to "Until"
	SignatureAlgorithm string `xml:"http://www.onvif.org/ver10/recording/wsdl SignatureAlgorithm,omitempty"`
...
type CertificateUsage struct {
	...
	Critical bool `xml:"http://www.onvif.org/ver10/recording/wsdl Critical,attr,omitempty"`
}
...
type Dot1XConfiguration struct {
	Dot1XConfigurationToken ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl Dot1XConfigurationToken,omitempty"`

	Identity string `xml:"http://www.onvif.org/ver10/recording/wsdl Identity,omitempty"`

	AnonymousID string `xml:"http://www.onvif.org/ver10/recording/wsdl AnonymousID,omitempty"`
	...
	CACertificateID []string `xml:"http://www.onvif.org/ver10/recording/wsdl CACertificateID,omitempty"`
...
type PTZNode struct {
	*DeviceEntity
	...
	//
	HomeSupported bool `xml:"http://www.onvif.org/ver10/recording/wsdl HomeSupported,omitempty"`
	...
	FixedHomePosition bool `xml:"http://www.onvif.org/ver10/recording/wsdl FixedHomePosition,attr,omitempty"`

	//
	// Indication whether the Node supports the geo-referenced move command.
	//

	GeoMove bool `xml:"http://www.onvif.org/ver10/recording/wsdl GeoMove,attr,omitempty"`
}
...
type PTZConfiguration struct {
	*ConfigurationEntity
	...
	//
	NodeToken ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl NodeToken,omitempty"`
...
type PTZPresetTourPresetDetail struct {
	...
	PresetToken ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl PresetToken,omitempty"`
	...
	Home bool `xml:"http://www.onvif.org/ver10/recording/wsdl Home,omitempty"`
...
type PTZPresetTourStartingCondition struct {
	...
	RandomPresetOrder bool `xml:"http://www.onvif.org/ver10/recording/wsdl RandomPresetOrder,attr,omitempty"`
}
...
type IrCutFilterAutoAdjustment struct {
	...
	BoundaryType string `xml:"http://www.onvif.org/ver10/recording/wsdl BoundaryType,omitempty"`
...
type ToneCompensation struct {
	...
	Mode string `xml:"http://www.onvif.org/ver10/recording/wsdl Mode,omitempty"`
...
type IrCutFilterAutoAdjustmentOptions struct {
	...
	BoundaryOffset bool `xml:"http://www.onvif.org/ver10/recording/wsdl BoundaryOffset,omitempty"`
...
type FocusConfiguration20 struct {
	...
	AFMode StringAttrList `xml:"http://www.onvif.org/ver10/recording/wsdl AFMode,attr,omitempty"`
}
...
type FocusOptions20Extension struct {
	...
	AFModes StringAttrList `xml:"http://www.onvif.org/ver10/recording/wsdl AFModes,omitempty"`
}
...
type ToneCompensationOptions struct {
	...
	Level bool `xml:"http://www.onvif.org/ver10/recording/wsdl Level,omitempty"`
}
...
type ItemList struct {
	SimpleItem []struct {
		...
		Name string `xml:"http://www.onvif.org/ver10/recording/wsdl Name,attr,omitempty"`
...
type MessageDescription struct {
	...
	IsProperty bool `xml:"http://www.onvif.org/ver10/recording/wsdl IsProperty,attr,omitempty"`
}
...
type ConfigDescription struct {
	...
	Messages []struct {
		*MessageDescription
		...
		//
		ParentTopic string `xml:"http://www.onvif.org/ver10/recording/wsdl ParentTopic,omitempty"`
...
type PaneLayout struct {
	...
	Pane ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl Pane,omitempty"`
...
type Receiver struct {
	...
	Token ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl Token,omitempty"`
...
type SearchScope struct {
	...
	IncludedRecordings []RecordingReference `xml:"http://www.onvif.org/ver10/recording/wsdl IncludedRecordings,omitempty"`
...
type VideoAttributes struct {
	...
	Encoding string `xml:"http://www.onvif.org/ver10/recording/wsdl Encoding,omitempty"`
...
type MetadataAttributes struct {
	...
	CanContainPTZ bool `xml:"http://www.onvif.org/ver10/recording/wsdl CanContainPTZ,omitempty"`

	// Indicates that there can be analytics data in the metadata track in the specified time interval.
	CanContainAnalytics bool `xml:"http://www.onvif.org/ver10/recording/wsdl CanContainAnalytics,omitempty"`

	// Indicates that there can be notifications in the metadata track in the specified time interval.
	CanContainNotifications bool `xml:"http://www.onvif.org/ver10/recording/wsdl CanContainNotifications,omitempty"`
	...
	PtzSpaces StringAttrList `xml:"http://www.onvif.org/ver10/recording/wsdl PtzSpaces,attr,omitempty"`
}
...
type RecordingJobConfiguration struct {
	...
	ScheduleToken string `xml:"http://www.onvif.org/ver10/recording/wsdl ScheduleToken,attr,omitempty"`
}
...
type RecordingJobSource struct {
	...
	AutoCreateReceiver bool `xml:"http://www.onvif.org/ver10/recording/wsdl AutoCreateReceiver,omitempty"`
...
type RecordingJobTrack struct {
	...
	SourceTag string `xml:"http://www.onvif.org/ver10/recording/wsdl SourceTag,omitempty"`

	// The destination is the tracktoken of the track to which the device shall store the
	// received data.
	Destination TrackReference `xml:"http://www.onvif.org/ver10/recording/wsdl Destination,omitempty"`
}
...
type RecordingJobStateInformation struct {
	...
	State RecordingJobState `xml:"http://www.onvif.org/ver10/recording/wsdl State,omitempty"`
...
type OSDPosConfiguration struct {
	...
	//
	Type string `xml:"http://www.onvif.org/ver10/recording/wsdl Type,omitempty"`
...
type OSDTextConfiguration struct {
	...
	//
	DateFormat string `xml:"http://www.onvif.org/ver10/recording/wsdl DateFormat,omitempty"`
	...
	//
	TimeFormat string `xml:"http://www.onvif.org/ver10/recording/wsdl TimeFormat,omitempty"`
	...
	PlainText string `xml:"http://www.onvif.org/ver10/recording/wsdl PlainText,omitempty"`
	...
	IsPersistentText bool `xml:"http://www.onvif.org/ver10/recording/wsdl IsPersistentText,attr,omitempty"`
}
...
type OSDImgOptions struct {
	...
	FormatsSupported StringAttrList `xml:"http://www.onvif.org/ver10/recording/wsdl FormatsSupported,attr,omitempty"`
...
type OSDConfigurationOptions struct {
	...
	//
	PositionOption []string `xml:"http://www.onvif.org/ver10/recording/wsdl PositionOption,omitempty"`
...
type FileProgress struct {
	...
	// Exported file name
	FileName string `xml:"http://www.onvif.org/ver10/recording/wsdl FileName,omitempty"`
...
type StorageReferencePath struct {
	...
	StorageToken ReferenceToken `xml:"http://www.onvif.org/ver10/recording/wsdl StorageToken,omitempty"`

	// gives the relative directory path on the storage
	RelativePath string `xml:"http://www.onvif.org/ver10/recording/wsdl RelativePath,omitempty"`
...
type RecordingPort interface {
	...
	*/
	CreateRecording(request *CreateRecording) (*CreateRecordingResponse, error)

	CreateRecordingContext(ctx context.Context, request *CreateRecording) (*CreateRecordingResponse, error)
	...
	This method is optional. It shall be available if the Recording/DynamicRecordings capability is TRUE.
	*/
	DeleteRecording(request *DeleteRecording) (*DeleteRecordingResponse, error)

	DeleteRecordingContext(ctx context.Context, request *DeleteRecording) (*DeleteRecordingResponse, error)
	...
	GetRecordings(request *GetRecordings) (*GetRecordingsResponse, error)

	GetRecordingsContext(ctx context.Context, request *GetRecordings) (*GetRecordingsResponse, error)

	/* SetRecordingConfiguration shall change the configuration of a recording. */
	SetRecordingConfiguration(request *SetRecordingConfiguration) (*SetRecordingConfigurationResponse, error)

	SetRecordingConfigurationContext(ctx context.Context, request *SetRecordingConfiguration) (*SetRecordingConfigurationResponse, error)

	/* GetRecordingConfiguration shall retrieve the recording configuration for a recording. */
	GetRecordingConfiguration(request *GetRecordingConfiguration) (*GetRecordingConfigurationResponse, error)

	GetRecordingConfigurationContext(ctx context.Context, request *GetRecordingConfiguration) (*GetRecordingConfigurationResponse, error)
	...
	GetRecordingOptions(request *GetRecordingOptions) (*GetRecordingOptionsResponse, error)

	GetRecordingOptionsContext(ctx context.Context, request *GetRecordingOptions) (*GetRecordingOptionsResponse, error)
	...
	*/
	CreateTrack(request *CreateTrack) (*CreateTrackResponse, error)

	CreateTrackContext(ctx context.Context, request *CreateTrack) (*CreateTrackResponse, error)
	...
	TRUE. */
	DeleteTrack(request *DeleteTrack) (*DeleteTrackResponse, error)

	DeleteTrackContext(ctx context.Context, request *DeleteTrack) (*DeleteTrackResponse, error)

	/* GetTrackConfiguration shall retrieve the configuration for a specific track. */
	GetTrackConfiguration(request *GetTrackConfiguration) (*GetTrackConfigurationResponse, error)

	GetTrackConfigurationContext(ctx context.Context, request *GetTrackConfiguration) (*GetTrackConfigurationResponse, error)

	/* SetTrackConfiguration shall change the configuration of a track. */
	SetTrackConfiguration(request *SetTrackConfiguration) (*SetTrackConfigurationResponse, error)

	SetTrackConfigurationContext(ctx context.Context, request *SetTrackConfiguration) (*SetTrackConfigurationResponse, error)
	...
	*/
	CreateRecordingJob(request *CreateRecordingJob) (*CreateRecordingJobResponse, error)

	CreateRecordingJobContext(ctx context.Context, request *CreateRecordingJob) (*CreateRecordingJobResponse, error)
	...
	other recording job. */
	DeleteRecordingJob(request *DeleteRecordingJob) (*DeleteRecordingJobResponse, error)

	DeleteRecordingJobContext(ctx context.Context, request *DeleteRecordingJob) (*DeleteRecordingJobResponse, error)

	/* GetRecordingJobs shall return a list of all the recording jobs in the device. */
	GetRecordingJobs(request *GetRecordingJobs) (*GetRecordingJobsResponse, error)

	GetRecordingJobsContext(ctx context.Context, request *GetRecordingJobs) (*GetRecordingJobsResponse, error)
	...
	*/
	SetRecordingJobConfiguration(request *SetRecordingJobConfiguration) (*SetRecordingJobConfigurationResponse, error)

	SetRecordingJobConfigurationContext(ctx context.Context, request *SetRecordingJobConfiguration) (*SetRecordingJobConfigurationResponse, error)

	/* GetRecordingJobConfiguration shall return the current configuration for a recording job. */
	GetRecordingJobConfiguration(request *GetRecordingJobConfiguration) (*GetRecordingJobConfigurationResponse, error)

	GetRecordingJobConfigurationContext(ctx context.Context, request *GetRecordingJobConfiguration) (*GetRecordingJobConfigurationResponse, error)
	...
	mode. */
	SetRecordingJobMode(request *SetRecordingJobMode) (*SetRecordingJobModeResponse, error)

	SetRecordingJobModeContext(ctx context.Context, request *SetRecordingJobMode) (*SetRecordingJobModeResponse, error)
	...
	GetRecordingJobState(request *GetRecordingJobState) (*GetRecordingJobStateResponse, error)

	GetRecordingJobStateContext(ctx context.Context, request *GetRecordingJobState) (*GetRecordingJobStateResponse, error)
	...
	*/
	ExportRecordedData(request *ExportRecordedData) (*ExportRecordedDataResponse, error)

	ExportRecordedDataContext(ctx context.Context, request *ExportRecordedData) (*ExportRecordedDataResponse, error)

	/*
		Stops the selected ExportRecordedData operation.
	*/
	StopExportRecordedData(request *StopExportRecordedData) (*StopExportRecordedDataResponse, error)

	StopExportRecordedDataContext(ctx context.Context, request *StopExportRecordedData) (*StopExportRecordedDataResponse, error)

	/*
		Retrieves the status of selected ExportRecordedData operation.
	*/
	GetExportRecordedDataState(request *GetExportRecordedDataState) (*GetExportRecordedDataStateResponse, error)

	GetExportRecordedDataStateContext(ctx context.Context, request *GetExportRecordedDataState) (*GetExportRecordedDataStateResponse, error)
}
...
func (service *recordingPort) GetServiceCapabilities(request *GetServiceCapabilities) (*GetServiceCapabilitiesResponse, error) {
...
func (service *recordingPort) CreateRecording(request *CreateRecording) (*CreateRecordingResponse, error) {
	return service.CreateRecordingContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) DeleteRecording(request *DeleteRecording) (*DeleteRecordingResponse, error) {
	return service.DeleteRecordingContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) GetRecordings(request *GetRecordings) (*GetRecordingsResponse, error) {
	return service.GetRecordingsContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) SetRecordingConfiguration(request *SetRecordingConfiguration) (*SetRecordingConfigurationResponse, error) {
	return service.SetRecordingConfigurationContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) GetRecordingConfiguration(request *GetRecordingConfiguration) (*GetRecordingConfigurationResponse, error) {
	return service.GetRecordingConfigurationContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) GetRecordingOptions(request *GetRecordingOptions) (*GetRecordingOptionsResponse, error) {
	return service.GetRecordingOptionsContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) CreateTrack(request *CreateTrack) (*CreateTrackResponse, error) {
	return service.CreateTrackContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) DeleteTrack(request *DeleteTrack) (*DeleteTrackResponse, error) {
	return service.DeleteTrackContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) GetTrackConfiguration(request *GetTrackConfiguration) (*GetTrackConfigurationResponse, error) {
	return service.GetTrackConfigurationContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) SetTrackConfiguration(request *SetTrackConfiguration) (*SetTrackConfigurationResponse, error) {
	return service.SetTrackConfigurationContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) CreateRecordingJob(request *CreateRecordingJob) (*CreateRecordingJobResponse, error) {
	return service.CreateRecordingJobContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) DeleteRecordingJob(request *DeleteRecordingJob) (*DeleteRecordingJobResponse, error) {
	return service.DeleteRecordingJobContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) GetRecordingJobs(request *GetRecordingJobs) (*GetRecordingJobsResponse, error) {
	return service.GetRecordingJobsContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) SetRecordingJobConfiguration(request *SetRecordingJobConfiguration) (*SetRecordingJobConfigurationResponse, error) {
	return service.SetRecordingJobConfigurationContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) GetRecordingJobConfiguration(request *GetRecordingJobConfiguration) (*GetRecordingJobConfigurationResponse, error) {
	return service.GetRecordingJobConfigurationContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) SetRecordingJobMode(request *SetRecordingJobMode) (*SetRecordingJobModeResponse, error) {
	return service.SetRecordingJobModeContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) GetRecordingJobState(request *GetRecordingJobState) (*GetRecordingJobStateResponse, error) {
	return service.GetRecordingJobStateContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) ExportRecordedData(request *ExportRecordedData) (*ExportRecordedDataResponse, error) {
	return service.ExportRecordedDataContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) StopExportRecordedData(request *StopExportRecordedData) (*StopExportRecordedDataResponse, error) {
	return service.StopExportRecordedDataContext(
		context.Background(),
		request,
	)
}
...
func (service *recordingPort) GetExportRecordedDataState(request *GetExportRecordedDataState) (*GetExportRecordedDataStateResponse, error) {
	return service.GetExportRecordedDataStateContext(
		context.Background(),
		request,
	)
}
